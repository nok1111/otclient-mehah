...
void main() {
    ...
    // Smoothly blend the energy color based on distance from center
    float auraStrength = smoothstep(0.001, 0.0012, distance);
    vec3 finalColor = mix(texColor.rgb, energyColor, pulsate * auraStrength);
