...
SpellInfo = {
  ['Custom'] = {
    ...
    ['Dragon Aura'] = {id = 9, words = 'dragon aura', icon_id = 9, description = 'create a dragon aura that deals fire damage to enemies around you. [maxHP+Magic]', exhaustion = 35000, premium = false, type = 'Instant', icon = 9, mana = 70, level = 33, soul = 0, group = {[1] = 1900}, vocations = {4}},
    ...
    ['Ice Barrage'] = {id = 55, words = 'ice barrage', icon_id = 55, description = 'shoot a group of icicles wich deals ice damage to your target.', exhaustion = 9000, premium = false, type = 'Instant', icon = 55, mana = 130, level = 18, soul = 0, group = {[1] = 1900}, vocations = {0}},
    ['Ice Wall'] = {id = 56, words = 'ice wall', icon_id = 56, description = 'create a ice wall wich extends horizontally blocking paths and enemies.', exhaustion = 12000, premium = false, type = 'Instant', icon = 56, mana = 200, level = 50, soul = 0, group = {[1] = 1900}, vocations = {0}}', exhaustion = 2000, premium = false, type = 'Instant', icon = 56, mana = 115, level = 42, soul = 0, group = {[1] = 2000}, vocations = {0}},
    ['Ice Clones'] = {id = 57, words = 'ice clones', icon_id = 57, description = 'create a 4 clones of yourself wich will follow you and deal ice damage to enemies.', exhaustion = 70000, premium = false, type = 'Instant', icon = 57, mana = 350, level = 1, soul = 0, group = {[1] = 1900}, vocations = {0}},
