...
SpellInfo = {
  ['Custom'] = {
    ...
    ['Summon Void Sentinel'] = {id = 69, words = 'summon void sentinel', icon_id = 69, description = 'summon a void sentinel wich damages enemies from the distance.', exhaustion = 60000, premium = false, type = 'Instant', icon = 69, mana = 300, level = 60, soul = 0, group = {[3] = 1900}, vocations = {5}},
    ...
    ['Dark Plague'] = {id = 71, words = 'dark plague', icon_id = 71, description = 'curse your target and all nearby enemies dealing death damage over 15 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 71, mana = 300, level = 1, soul = 0, group = {[1] = 2000}, vocations = {5}},
    ...
    ['Haunt'] = {id = 77, words = 'haunt', icon_id = 77, description = 'haunts the target and apply a curse to it and nearby enemies after impact wich last 10 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 77, mana = 250, level = 70, soul = 0, group = {[1] = 2000}, vocations = {5}},
