...
SpellInfo = {
  ['Custom'] = {
    ...
    ['Soul Rain'] = {id = 74, words = 'soul rain', icon = 74, description = 'cast a rain of death over your target position dealing death damage over 8 seconds.', exhaustion = 45000, premium = false, type = 'Instant', mana = 200, level = 85, soul = 0, group = {[1] = 2000}, vocations = {5}, crosshair = true, area = 'AREA_CIRCLE3X3', range = 7, areaSprite = 1178},
   ...
   --Stellar
    ...
    ['Arrow rain'] =                {id = 188, words = 'arrow rain', icon = 188, exhaustion = 15000, premium = false, type = 'Instant', mana = 200, level = 75, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'cast a arrow rain into the target dealing physical damage to all enemies in the area.[Weapon Damage, DISTANCE]', crosshair = true, area = 'AREA_ARROW_RAIN', range = 7, areaSprite = 1178},
    ...
    ['Wind Step'] = {id = 252, words = 'wind step', icon = 252, description = 'dash 5 tiles in a straight line leaving an after-image trail and damaging enemies along the path.', exhaustion = 8000, premium = false, type = 'Instant', mana = 30, level = 22, soul = 0, group = {[3] = 1900}, vocations = {13}, crosshair = true, area = 'WIND_STEP', range = 5, areaSprite = 1178},
    ...
    ['Blood Curse'] = {id = 298, words = 'blood curse', icon = 263, description = 'Debuff a target for 6 seconds: target takes +15% damage and healing received is reduced by 50%. Costs 3% max HP.', exhaustion = 12000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Rain'] = {id = 299, words = 'crimson rain', icon = 263, description = 'Call down a rain of blood on a 3x3 area for 5 seconds, applying bleeds to all enemies standing in it. Costs 5% max HP.', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Sanguine Shield'] = {id = 300, words = 'sanguine shield', icon = 263, description = 'For 5 seconds, 20% of incoming damage is converted to Blood Essence instead of dealing damage. Costs 3% max HP.', exhaustion = 15000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 263, description = 'For 10 seconds, all allies within 5 tiles gain 10% lifesteal. Costs 5% max HP.', exhaustion = 20000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Walk'] = {id = 302, words = 'blood walk', icon = 263, description = 'Teleport to a bleeding target within 6 tiles, dealing AoE damage on arrival. Costs 3% max HP.', exhaustion = 6000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Crimson Chains'] = {id = 303, words = 'crimson chains', icon = 263, description = 'Root all enemies within 3 tiles for 3 seconds. Costs 4% max HP.', exhaustion = 12000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Ritual'] = {id = 304, words = 'blood ritual', icon = 263, description = 'Toggle: sacrifice 5% HP per second for 15 Blood Essence per second. Cast again to toggle off.', exhaustion = 1000, premium = false, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ...
    ['Avalanche Stomp'] = {id = 283, words = 'avalanche stomp', icon = 281, description = 'Deal ice damage around you. Consumes Frost Mark to expand the area and stun enemies.', exhaustion = 7000, premium = false, type = 'Instant', mana = 45, level = 14, soul = 0, group = {[1] = 1900}, vocations = {15}},
    ['Barkskin'] = {id = 284, words = 'barkskin', icon = 271, description = 'Shield yourself; stronger with Earth Mark. Consumes Earth Mark.', exhaustion = 10000, premium = false, type = 'Instant', mana = 30, level = 20, soul = 0, group = {[2] = 1900}, vocations = {15}},
    ['Sylvan Mend'] = {id = 285, words = 'sylvan mend', icon = 284, description = 'Heal yourself or an ally; stronger with Earth Mark. Consumes Earth Mark.', exhaustion = 8000, premium = false, type = 'Instant', mana = 35, level = 18, soul = 0, group = {[2] = 1900}, vocations = {15}},
    ['Frozen Earth'] = {id = 286, words = 'frozen earth', icon = 275, description = 'Deal earth damage around you. Applies Earth Mark.', exhaustion = 12000, premium = false, type = 'Instant', mana = 40, level = 24, soul = 0, group = {[1] = 1900}, vocations = {15}},
    ["Guardian's Bulwark"] = {id = 287, words = 'guardian bulwark', icon = 277, description = 'Shield nearby allies; stronger with Earth Mark. Consumes Earth Mark.', exhaustion = 18000, premium = false, type = 'Instant', mana = 50, level = 30, soul = 0, group = {[2] = 1900}, vocations = {15}},
