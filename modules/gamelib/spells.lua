...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Exsanguinate'] = {id = 312, words = 'exsanguinate', icon = 265, description = 'Drain life from your target dealing heavy lifedrain damage. +50% damage if target is below 30% HP. Consumes all Blood Orbs for +10% damage each. 30% lifesteal. Costs 12% max HP.', exhaustion = 15000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
