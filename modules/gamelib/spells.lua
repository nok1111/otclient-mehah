...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Blood Threads'] = {id = 263, words = 'blood threads', icon = 250, description = 'Unleash crimson threads in a cone before you, dealing physical damage and applying a curse to all enemies hit that deals death damage over time. Visual crimson lines connect you to all targets. Costs 7% max HP.', exhaustion = 8000, premium = false, type = 'Instant', mana = 0, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in a large AoE dealing death damage. Consumes all active bleeds and curses on targets hit: +20% damage per effect consumed. Heals you for 5% max HP per bleed or curse consumed (cap 30%). More targets with bleeds/curses means more healing. Generates 15 Blood Essence. Costs 7% max HP.', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 260, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). Scales with Bleed & Curse Mastery and Risk Multiplier. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Curse your target with a spreading blood plague that leaves a bleeding wound dealing death damage over 8 seconds (1 tick per second). Each tick spreads the plague to one nearby uninfected enemy within 3 tiles. Infected targets count as bleeding for Blood Eruption and other bleed synergies. Generates 3 Blood Essence per tick. Costs 5% max HP.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
