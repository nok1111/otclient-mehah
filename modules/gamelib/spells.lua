...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Blood Threads'] = {id = 263, words = 'blood threads', icon = 250, description = 'Unleash crimson threads in a cone before you, dealing physical damage and applying a curse to all enemies hit that deals death damage over time. {Costs 4% max HP., #e74c3c} {Generates 25 Blood Essence., #c0392b} {Generates 1 Blood Orb, #8b0000} if cast during {Blood Frenzy., #e67e22}', exhaustion = 8000, premium = false, type = 'Instant', mana = 0, hpCost = 4, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in a large AoE dealing death damage. Consumes all active bleeds and curses on targets hit: +20% damage per effect consumed. Heals 5% max HP per bleed/curse consumed (cap 30%). {Consumes ALL Blood Orbs, #8b0000} for +5% max HP heal each. {Generates 15 Blood Essence., #c0392b} {Costs 5% max HP., #e74c3c}', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, hpCost = 5, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 260, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). {Generates 15 Blood Essence per tick., #c0392b} Scales with Bleed & Curse Mastery and Risk Multiplier. {Costs 2% max HP., #e74c3c}', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 2, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Curse your target with a spreading blood plague that leaves a bleeding wound dealing death damage over 8 seconds (1 tick per second). Each tick spreads the plague to one nearby uninfected enemy within 3 tiles (max 5 spreads). Infected targets count as bleeding for Blood Eruption. {Generates 3 Blood Essence per tick., #c0392b} {Costs 3% max HP., #e74c3c}', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ...
    ['Blood Ritual'] = {id = 304, words = 'blood ritual', icon = 274, description = 'Toggle: sacrifice 5% HP per second for {15 Blood Essence per second., #c0392b} Cast again to toggle off.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 5, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Exsanguinate'] = {id = 312, words = 'exsanguinate', icon = 265, description = 'Strike your target dealing heavy death damage. +50% damage if target is below 30% HP. {Consumes ALL Blood Orbs, #8b0000} for +10% damage each. Heals you based on your level, max HP and magic level. {Costs 8% max HP., #e74c3c} Sanguine Strike: on kill or execute, refunds Blood Orbs.', exhaustion = 15000, premium = false, type = 'Instant', mana = 0, hpCost = 8, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
