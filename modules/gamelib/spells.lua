...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Blood Siphon'] = {id = 261, words = 'blood siphon', icon = 249, description = 'Send multiple blood missiles at your target dealing death damage. Costs 5% max HP. Generates Blood Essence per missile hit. Heals you based on your level, max HP and magic level.', exhaustion = 5000, premium = false, type = 'Instant', mana = 0, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Sigil'] = {id = 262, words = 'crimson sigil', icon = 253, description = 'Spend 50 Blood Essence to activate Crimson Sigil for 12 seconds. +20% damage, +10% heal bonus, and Sanguine Bolt gains 25% chance to apply bleed. Costs 10% max HP.', exhaustion = 18000, premium = false, type = 'Instant', mana = 0, level = 22, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Blood Threads'] = {id = 263, words = 'blood threads', icon = 250, description = 'Unleash crimson threads in a cone before you, dealing physical damage and applying a curse to all enemies hit that deals death damage over time. Costs 7% max HP. Generates 25 Blood Essence. Generates 1 Blood Orb if cast during Blood Frenzy.', exhaustion = 8000, premium = false, type = 'Instant', mana = 0, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in a large AoE dealing death damage. Consumes all active bleeds and curses on targets hit: +20% damage per effect consumed. Heals 5% max HP per bleed/curse consumed (cap 30%). Consumes ALL Blood Orbs for +5% max HP heal each. Generates 15 Blood Essence. Costs 7% max HP.', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 260, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). Generates 15 Blood Essence per tick. Scales with Bleed & Curse Mastery and Risk Multiplier. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Curse your target with a spreading blood plague that leaves a bleeding wound dealing death damage over 8 seconds (1 tick per second). Each tick spreads the plague to one nearby uninfected enemy within 3 tiles (max 5 spreads). Infected targets count as bleeding for Blood Eruption. Generates 3 Blood Essence per tick. Costs 5% max HP.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
