  ...
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Counter Strike'] = {id = 299, words = 'counter strike', icon = 297, description = 'Passive: while Guardian Stance is active, you have a chance to automatically counter-attack when hit, dealing physical damage and generating 1 Focus. Chance: 10% base + 3% per Parry level.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
        ...
        --Blood Mage
    ['Sanguine Bolt'] = {id = 260, words = 'sanguine bolt', icon = 248, description = 'Fire a blood bolt at your target dealing physical damage. Costs 3% max HP, generates 12 Blood Essence. +8% damage per Blood Orb held. If Crimson Sigil is active, 25% chance to apply a bleed for 3 ticks.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Siphon'] = {id = 261, words = 'blood siphon', icon = 249, description = 'Send multiple blood missiles at your target dealing death damage. Generates Blood Essence per missile hit and heals you based on your level, max HP and magic level.', exhaustion = 5000, premium = false, type = 'Instant', mana = 0, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Sigil'] = {id = 262, words = 'crimson sigil', icon = 253, description = 'Consume 50 Blood Essence to activate Crimson Sigil for 12 seconds. +20% damage, +10% heal bonus, and Sanguine Bolt gains 25% chance to apply bleed. Costs 10% max HP.', exhaustion = 18000, premium = false, type = 'Instant', mana = 0, level = 22, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ...
    ['Blood Tether'] = {id = 269, words = 'blood tether', icon = 252, description = 'Bind your target with a blood tether that deals death damage for 8 ticks. Generates 4 Blood Essence per tick and heals you based on your level, max HP and magic level. If the target dies while tethered, gain 1 Blood Orb. Costs 7% max HP.', exhaustion = 15000, premium = false, type = 'Instant', mana = 0, level = 45, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Bloodletting Curse'] = {id = 264, words = 'bloodletting curse', icon = 260, description = 'Curse your target with a powerful death damage nuke that applies a bleed dealing damage over time and generates Blood Essence. Heals you based on your level, max HP and magic level. Costs 5% max HP.', exhaustion = 12000, premium = false, type = 'Instant', mana = 0, level = 53, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in an AoE dealing death damage. Consumes all active bleeds on targets hit: +20% damage per bleed consumed. Grants a shield equal to 5% max HP per bleed consumed (cap 30%). Heals you based on your level, max HP and magic level. Generates 15 Blood Essence. Costs 7% max HP.', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Lance'] = {id = 266, words = 'blood lance', icon = 258, description = 'Thrust a blood lance in a straight line dealing heavy physical damage. Consumes all Blood Orbs for bonus damage and applies a bleed. Heals you based on your level, max HP and magic level. Synergizes with Blood Frenzy for increased damage. Costs 6% max HP.', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, level = 70, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ...
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 66, description = 'Debuff a target for 6 seconds: target takes +15% damage and healing received is reduced by 50%. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Rain'] = {id = 314, words = 'crimson rain', icon = 58, description = 'Call down a rain of blood on a 3x3 area for 5 seconds, applying bleeds to all enemies standing in it. Costs 5% max HP.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ...
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 256, description = 'For 10 seconds, all allies within 5 tiles gain 10% bonus healing. Costs 5% max HP.', exhaustion = 20000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
