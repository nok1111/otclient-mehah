...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Second Wind'] = {id = 294, words = 'second wind', icon = 65, description = 'Instantly heal 30% max HP + 20% per Focus stack consumed. Consumes all Focus.', exhaustion = 20000, premium = false, needLearn = true, type = 'Instant', mana = 50, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ...
    ['Meditation'] = {id = 297, words = 'meditation', icon = 294, description = 'Channel for 1 second to instantly gain 3 Focus stacks. Respects Focus Mastery (up to 6 max).', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 25, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Blade Flurry'] = {id = 298, words = 'blade flurry', icon = 293, description = 'Strike a target 3 times in rapid succession, dealing physical damage. The final hit applies Exposed (max 3 stacks, 8s). Exposed targets take +10% damage from finishers per stack. Builder: generates 1 Focus stack.', exhaustion = 3500, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}},
