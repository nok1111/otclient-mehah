...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Vampiric Curse'] = {id = 264, words = 'vampiric curse', icon = 260, description = 'Curse your target with a powerful death damage nuke that applies a bleed dealing damage over time and generates Blood Essence. Heals you based on your level, max HP and magic level. Costs 5% max HP.', exhaustion = 12000, premium = false, type = 'Instant', mana = 0, level = 53, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ...
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 66, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). Scales with Bleed & Curse Mastery and Risk Multiplier. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Infect a target with a spreading blood plague: death damage DoT that ticks every second for 8 seconds. Each tick spreads the plague to one nearby uninfected enemy within 3 tiles. Each infected target counts as a bleed for Blood Eruption. Generates 3 Blood Essence per tick. Costs 5% max HP.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
