  ...
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Counter Strike'] = {id = 299, words = 'counter strike', icon = 297, description = 'Passive: while Guardian Stance is active, you have a chance to automatically counter-attack when hit, dealing physical damage and {generating 1 Focus., #5dade2} Chance: 10% base + 3% per Parry level.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
        ...
        --Blood Mage
    ['Sanguine Bolt'] = {id = 260, words = 'sanguine bolt', icon = 248, description = 'Fire a blood bolt at your target dealing physical damage. {Costs 3% max HP., #e74c3c} {Generates 12 Blood Essence., #c0392b} +8% damage per {Blood Orb, #8b0000} held. If Crimson Sigil is active, 25% chance to apply a bleed for 3 ticks.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Siphon'] = {id = 261, words = 'blood siphon', icon = 249, description = 'Send multiple blood missiles at your target dealing death damage. {Costs 5% max HP., #e74c3c} {Generates Blood Essence, #c0392b} per missile hit. Heals you based on your level, max HP and magic level.', exhaustion = 5000, premium = false, type = 'Instant', mana = 0, hpCost = 5, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Sigil'] = {id = 262, words = 'crimson sigil', icon = 253, description = '{Spends 50 Blood Essence, #c0392b} to activate Crimson Sigil for 12 seconds. +20% damage, +10% heal bonus, and Sanguine Bolt gains 25% chance to apply bleed. {Costs 10% max HP., #e74c3c}', exhaustion = 18000, premium = false, type = 'Instant', mana = 0, hpCost = 10, level = 22, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Blood Threads'] = {id = 263, words = 'blood threads', icon = 250, description = 'Unleash crimson threads in a cone before you, dealing physical damage and applying a curse to all enemies hit that deals death damage over time. {Costs 7% max HP., #e74c3c} {Generates 25 Blood Essence., #c0392b} {Generates 1 Blood Orb, #8b0000} if cast during {Blood Frenzy., #e67e22}', exhaustion = 8000, premium = false, type = 'Instant', mana = 0, hpCost = 7, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in a large AoE dealing death damage. Consumes all active bleeds and curses on targets hit: +20% damage per effect consumed. Heals 5% max HP per bleed/curse consumed (cap 30%). {Consumes ALL Blood Orbs, #8b0000} for +5% max HP heal each. {Generates 15 Blood Essence., #c0392b} {Costs 7% max HP., #e74c3c}', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, hpCost = 7, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 260, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). {Generates 15 Blood Essence per tick., #c0392b} Scales with Bleed & Curse Mastery and Risk Multiplier. {Costs 3% max HP., #e74c3c}', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Curse your target with a spreading blood plague that leaves a bleeding wound dealing death damage over 8 seconds (1 tick per second). Each tick spreads the plague to one nearby uninfected enemy within 3 tiles (max 5 spreads). Infected targets count as bleeding for Blood Eruption. {Generates 3 Blood Essence per tick., #c0392b} {Costs 5% max HP., #e74c3c}', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 5, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Sanguine Shield'] = {id = 300, words = 'sanguine shield', icon = 70, description = 'For 5 seconds, 20% of incoming damage is converted to {Blood Essence, #c0392b} instead of dealing damage. {Costs 3% max HP., #e74c3c}', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 256, description = 'For 30 minutes, all party members gain 5% lifesteal. {Costs 5% max HP., #e74c3c}', exhaustion = 30000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 5, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Walk'] = {id = 302, words = 'blood walk', icon = 251, description = 'Teleport to a bleeding target within 6 tiles, dealing AoE damage on arrival. {Consumes 1 Blood Orb, #8b0000} for +50% damage and applies a bleed to nearby enemies. {Costs 3% max HP., #e74c3c}', exhaustion = 6000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Crimson Chains'] = {id = 303, words = 'crimson chains', icon = 264, description = 'Root all enemies within 3 tiles for 3 seconds. {Costs 4% max HP., #e74c3c}', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 4, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
