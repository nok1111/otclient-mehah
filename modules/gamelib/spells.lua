...
SpellInfo = {
  ['Custom'] = {
    ...
    ['Summon Void Sentinel'] = {id = 69, words = 'summon void sentinel', icon_id = 69, description = 'summon a void sentinel wich damages enemies from the distance.', exhaustion = 60000, premium = false, type = 'Instant', icon = 69, mana = 300, level = 60, soul = 0, group = {[3] = 1900}, vocations = {5}, needLearn = true},
    ...
    ['Dark Plague'] = {id = 71, words = 'dark plague', icon_id = 71, description = 'curse your target and all nearby enemies dealing death damage over 15 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 71, mana = 300, level = 1, soul = 0, group = {[1] = 2000}, vocations = {5}, needLearn = true},
    ['Soul Rain'] = {id = 74, words = 'soul rain', icon_id = 74, description = 'cast a rain of death over your target position dealing death damage over 8 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 74, mana = 200, level = 85, soul = 0, group = {[1] = 2000}, vocations = {5}},
    ['Drain Soul'] = {id = 75, words = 'drain soul', icon_id = 75, description = 'drain the souls of nearby enemies healing yourself and dealing death damage.', exhaustion = 2000, premium = false, type = 'Instant', icon = 75, mana = 150, level = 53, soul = 0, group = {[1] = 2000}, vocations = {5}},
    ['Malediction'] = {id = 76, words = 'malediction', icon_id = 76, description = 'cast a strong plague to your target that deals death damage on impact.', exhaustion = 2000, premium = false, type = 'Instant', icon = 76, mana = 150, level = 1, soul = 0, group = {[1] = 2000}, vocations = {5}, needLearn = true},
    ...
    --Nightblade
    ['Stealth'] = {id = 80, words = 'stealth', icon_id = 80, description = 'enter stealth for 2.5 seconds wich makes you invisible to enemies and damage.', exhaustion = 60000, premium = false, type = 'Instant', icon = 80, mana = 110, level = 85, soul = 0, group = {[1] = 5000}, vocations = {3}},
    ...
    ['Shadow Form'] = {id = 87, words = 'shadow form', icon_id = 87, description = 'enter a shadow state that heals you for the duration.', exhaustion = 30000, premium = false, type = 'Instant', icon = 87, mana = 65, level = 80, soul = 0, group = {[2] = 3000}, vocations = {3}},
   ...
   --Stellar
    ...
    ['Starfall'] = {id = 103, words = 'starfall', icon_id = 103, description = 'call a starfall over your target position dealing energy damage and restoring mana.', exhaustion = 7000, premium = false, type = 'Instant', icon = 103, mana = 0, level = 38, soul = 0, group = {[1] = 0}, vocations = {6}},
    ...
    ['Rejuvenation'] = {id = 153, words = 'rejuvenation', icon_id = 153, description = 'apply a rejuvenation effect to yourself wich heals overtime for 8 seconds.', exhaustion = 13000, premium = false, type = 'Instant', icon = 153, mana = 120, level = 53, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Insect Swarm'] = {id = 154, words = 'insect swarm', icon_id = 154, description = 'cast a swarm of insects to your target wich deals nature damage and applies a infection effect to all nerby enemies on wich it can spread.', exhaustion = 18000, premium = false, type = 'Instant', icon = 154, mana = 250, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true},
    ...
    ['Carnivorous Vile'] = {id = 156, words = 'carnivorous vile', icon_id = 156, description = 'cast a carnivorous vile wich devours its target dealing earth damage, if your target was infected by poison/earth/nature it does extra damage.', exhaustion = 7000, premium = false, type = 'Instant', icon = 156, mana = 85, level = 38, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ...
    ['Piercing Wave'] = {id = 159, words = 'piercing wave', icon_id = 159, description = 'send a piercing wave that deals physical damage.', exhaustion = 12000, premium = false, type = 'Instant', icon = 159, mana = 155, level = 45, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ...
    ['Wrath of Nature'] = {id = 162, words = 'wrath of nature', icon_id = 162, description = 'cast a thunderstorm at your target position wich deals energy damage.', exhaustion = 30000, premium = false, type = 'Instant', icon = 162, mana = 420, level = 80, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Focus Healing'] = {id = 165, words = 'focus healing', icon_id = 165, description = 'strong heal, that heals your friendly target', exhaustion = 1000, parameter = true, premium = false, type = 'Instant', icon = 165, mana = 140, level = 60, soul = 0, group = {[2] = 1900}, vocations = {8}, needLearn = true},
    ['Ice Shatter'] = {id = 166, words = 'ice shatter', icon_id = 166, description = 'create a ice block wich deals ice damage and it shatters itself to deal ice damage to all enemies in its radius.', exhaustion = 5500, premium = false, type = 'Instant', icon = 166, mana = 130, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true},
    ['Frost Armor'] = {id = 168, words = 'frost armor', icon_id = 168, description = 'cast a frost armor wich reduces damage taken by 20% for 8 seconds.', exhaustion = 5500, premium = false, type = 'Instant', icon = 168, mana = 85, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true},
