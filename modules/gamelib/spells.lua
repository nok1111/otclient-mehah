...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 256, description = 'For 30 minutes, all allies within 5 tiles gain 5% lifesteal. {Costs 5% max HP., #e74c3c}', exhaustion = 30000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
