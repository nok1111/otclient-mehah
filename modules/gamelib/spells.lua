...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Flash Steel'] = {id = 291, words = 'flash steel', icon = 287, description = 'hurl a blade of energy at a target up to 4 tiles away. Generates 1 Focus.', exhaustion = 3000, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 8, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Death Mark'] = {id = 292, words = 'death mark', icon = 292, description = 'mark a target for 8 seconds. Your finisher spells deal +20% damage to marked targets.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 25, level = 8, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Iron Skin'] = {id = 293, words = 'iron skin', icon = 297, description = 'reduce all damage taken by 30% + 10% per Focus stack consumed for 3 seconds. Consumes all Focus.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 40, level = 8, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Second Wind'] = {id = 294, words = 'second wind', icon = 297, description = 'instantly heal 15% max HP + 10% per Focus stack consumed. Consumes all Focus.', exhaustion = 20000, premium = false, needLearn = true, type = 'Instant', mana = 50, level = 8, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Cyclone Slash'] = {id = 295, words = 'cyclone slash', icon = 289, description = 'spin in a whirlwind dealing physical damage to all enemies within 3 tiles. Generates 1 Focus.', exhaustion = 4000, premium = false, needLearn = true, type = 'Instant', mana = 30, level = 8, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Searing Wind'] = {id = 296, words = 'searing wind', icon = 252, description = 'passive: your Wind Step leaves a trail of fire that burns enemies.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Meditation'] = {id = 297, words = 'meditation', icon = 297, description = 'channel for 1 second to instantly gain 3 Focus stacks.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 8, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ...
    ['Blood Curse'] = {id = 298, words = 'blood curse', icon = 263, description = 'Debuff a target for 6 seconds: target takes +15% damage and healing received is reduced by 50%. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Rain'] = {id = 299, words = 'crimson rain', icon = 263, description = 'Call down a rain of blood on a 3x3 area for 5 seconds, applying bleeds to all enemies standing in it. Costs 5% max HP.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Sanguine Shield'] = {id = 300, words = 'sanguine shield', icon = 263, description = 'For 5 seconds, 20% of incoming damage is converted to Blood Essence instead of dealing damage. Costs 3% max HP.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 263, description = 'For 10 seconds, all allies within 5 tiles gain 10% lifesteal. Costs 5% max HP.', exhaustion = 20000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Walk'] = {id = 302, words = 'blood walk', icon = 263, description = 'Teleport to a bleeding target within 6 tiles, dealing AoE damage on arrival. Costs 3% max HP.', exhaustion = 6000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Crimson Chains'] = {id = 303, words = 'crimson chains', icon = 263, description = 'Root all enemies within 3 tiles for 3 seconds. Costs 4% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Ritual'] = {id = 304, words = 'blood ritual', icon = 263, description = 'Toggle: sacrifice 5% HP per second for 15 Blood Essence per second. Cast again to toggle off.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 8, soul = 0, group = {[3] = 1100}, vocations = {14}},
