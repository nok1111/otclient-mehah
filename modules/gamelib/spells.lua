...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['War Cry'] = {id = 291, words = 'war cry', icon = 314, description = 'Grant +10% damage to yourself and nearby party members for 8 seconds. Support spell that complements any build.', exhaustion = 18000, premium = false, needLearn = true, type = 'Instant', mana = 30, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ...
    ['Phantom Slash'] = {id = 293, words = 'phantom slash', icon = 311, description = 'Dash through all enemies in a line up to 4 tiles, dealing physical damage to each. Leaves after-images along the path.', exhaustion = 8000, premium = false, needLearn = true, type = 'Instant', mana = 35, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ...
    ['Rocket Boots'] = {id = 325, words = 'rocket boots', icon = 326, description = 'Dash up to 4 tiles in the target direction.', exhaustion = 10000, premium = false, type = 'Instant', mana = 25, level = 25, soul = 0, group = {[3] = 1100}, vocations = {12}, crosshair = true, area = 'ROCKET_BOOTS', range = 4, areaSprite = 1178},
    ...
    ['Gravity Bomb'] = {id = 351, words = 'gravity bomb', icon = 343, description = 'Launch a gravity bomb at target dealing physical damage. Pulls nearby enemies toward impact point and slows them for 2s. Consumes 2 Scrap.', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 35, level = 25, soul = 0, group = {[1] = 1900}, vocations = {12}},
