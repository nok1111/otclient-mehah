  ...
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Meditation'] = {id = 297, words = 'meditation', icon = 297, description = 'channel for 1 second to instantly gain 3 Focus stacks.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
        ...
        --Blood Mage
    ['Sanguine Bolt'] = {id = 260, words = 'sanguine bolt', icon = 248, description = 'Fire a blood bolt at your target dealing death damage. Costs 3% max HP, generates 12 Blood Essence. +8% damage per Blood Orb held. If Crimson Sigil is active, 25% chance to apply a bleed for 3 ticks.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
