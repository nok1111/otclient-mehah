...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Searing Wind'] = {id = 296, words = 'searing wind', icon = 252, description = 'Passive: your Wind Step leaves a trail of fire for 3 seconds that burns enemies standing in it.', exhaustion = 1000, premium = false, needLearn = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
