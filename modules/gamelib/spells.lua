...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    -- Bard
    ['Cheerful Melody'] = {id = 270, words = 'cheerful melody', icon = 228, description = 'Aura: +20% healing received. Burst: AoE heal on cast. +12 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 30, level = 8, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ...
    ['Menacing Melody'] = {id = 272, words = 'menacing melody', icon = 235, description = 'Aura: enemies +15% damage taken. Burst: 1.5s AoE stun on cast. +12 {Harmony,#d23cff}.', exhaustion = 12000, premium = false, type = 'Instant', mana = 35, level = 45, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Cathartic Melody'] = {id = 273, words = 'cathartic melody', icon = 223, description = 'Aura: +15% damage output. Burst: AoE energy damage on cast. +14 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 40, level = 53, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ...
    ['Echo Strike'] = {id = 275, words = 'echo strike', icon = 232, description = 'Single target damage. Applies Resonance for 6s. Resonating enemies emit a small sonic wave when hit (0.5s cd). +10 {Dissonance,#ffc832}.', exhaustion = 4000, premium = false, type = 'Instant', mana = 15, level = 1, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ...
    ['Reverberation'] = {id = 280, words = 'reverberation', icon = 240, description = '5s aura: every resonating enemy that takes damage emits a sonic wave (1s cd per enemy). Does not consume Resonance. +10 {Harmony,#d23cff}.', exhaustion = 15000, premium = false, type = 'Instant', mana = 60, level = 53, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Grand Finale'] = {id = 279, words = 'grand finale', icon = 226, description = 'Requires {Dissonance,#ffc832} or {Harmony,#d23cff} at 100%. {Dissonance,#ffc832}: Apocalypse Crescendo - massive holy AoE + debuff enemies. {Harmony,#d23cff}: Elysian Symphony - party heal + cleanse + defense. Resets {Dissonance,#ffc832}/{Harmony,#d23cff} to 50 (65 with Finale Mastery, 75 with Virtuoso\'s Finale).', exhaustion = 30000, premium = false, type = 'Instant', mana = 120, level = 80, soul = 0, group = {[1] = 1900}, vocations = {11}},
