...
SpellInfo = {
  ['Custom'] = {
    ...
    -- Dragon Knight
    ['Rend'] = {id = 1, words = 'rend', icon_id = 1, description = 'rend the target dealing physical damage and reaching nearby enemies.', exhaustion = 2000, premium = false, type = 'Instant', icon = 1, mana = 20, level = 8, soul = 0, group = {[1] = 2000}, vocations = {4}},
    ['Brutal Swing'] = {id = 2, words = 'brutal swing', icon_id = 2, description = 'smash the target dealing high ammounts of physical damage, the targeted area can vary based on one handed or two handed weapon.', exhaustion = 2000, premium = false, type = 'Instant', icon = 2, mana = 55, level = 18, soul = 0, group = {[1] = 2000}, vocations = {4}},
    ['Ripping Slash'] = {id = 3, words = 'ripping slash', icon_id = 3, description = 'slash your way through enemies dealing physical damage in a small cone area.', exhaustion = 2000, premium = false, type = 'Instant', icon = 3, mana = 30, level = 20, soul = 0, group = {[3] = 2000}, vocations = {4}},
    ['Fire Within'] = {id = 4, words = 'fire within', icon_id = 4, description = 'ignite yourself into fire to deal fire damage to your nearest enemy and spread it to nearby enemies.', exhaustion = 2000, premium = false, type = 'Instant', icon = 4, mana = 75, level = 70, soul = 0, group = {[1] = 2000}, vocations = {4}},
    ['Charge'] = {id = 5, words = 'charge', icon_id = 5, description = 'charge into your target from the distance and stun it for 1 second.', exhaustion = 2000, premium = false, type = 'Instant', icon = 5, mana = 70, level = 40, soul = 0, group = {[3] = 2000}, vocations = {4}},
    ['whirlwind'] = {id = 6, words = 'whirlwind', icon_id = 6, description = 'slash your surroundings dealing fire damage and igniting all enemies in the area.', exhaustion = 2000, premium = false, type = 'Instant', icon = 6, mana = 85, level = 30, soul = 0, group = {[1] = 2000}, vocations = {4}},
    ...
    ['Dragons Call'] = {id = 10, words = 'dragons call', icon_id = 10, description = 'strike your target high a powerfull blow dealing high amounts of fire damage.', exhaustion = 2000, premium = false, type = 'Instant', icon = 10, mana = 85, level = 100, soul = 0, group = {[1] = 2000}, vocations = {4}},
    ...
    ['Dragon Soul'] = {id = 14, words = 'dragon soul', icon_id = 14, description = 'restore high amounts of max health scaled by your max health percent and magic.', exhaustion = 2000, premium = false, type = 'Instant', icon = 14, mana = 20, level = 1, soul = 0, group = {[2] = 2000}, vocations = {4}},
    
    -- Templar
    ['Divine Punishment'] = {id = 20, words = 'divine punishment', icon_id = 20, description = 'call down judgement to a enemy dealing high amounts of holy damage after a shot delay', exhaustion = 2000, premium = false, type = 'Instant', icon = 20, mana = 200, level = 100, soul = 0, group = {[1] = 2000}, vocations = {2}},
    ['Penitence'] = {id = 21, words = 'penitence', icon_id = 21, description = 'send a holy shield wich deals holy damage and taunts all enemies. player will be healed based on the damage dealt per every creature hit', exhaustion = 2000, premium = false, type = 'Instant', icon = 21, mana = 60, level = 25, soul = 0, group = {[1] = 2000}, vocations = {2}},
    ...
    ['Holy Strike'] = {id = 24, words = 'holy strike', icon_id = 24, description = 'after a short delay strike your target with a holy sentence.', exhaustion = 2000, premium = false, type = 'Instant', icon = 24, mana = 50, level = 18, soul = 0, group = {[1] = 2000}, vocations = {2}},
    ['Divine Storm'] = {id = 25, words = 'divine storm', icon_id = 25, description = 'create a holy storm wich deals damage in a radius and heals you and your nearby allies.', exhaustion = 2000, premium = false, type = 'Instant', icon = 25, mana = 150, level = 70, soul = 0, group = {[1] = 2000}, vocations = {2}},
    ...
    ['Kings Blessing'] = {id = 30, words = 'Kings Blessing', icon_id = 30, description = 'bless you and all party members increasing their combat stats by 8% for 20 minutes.', exhaustion = 2000, premium = false, type = 'Instant', icon = 30, mana = 50, level = 60, soul = 0, group = {[3] = 2000}, vocations = {2}},
    ...
    ['Judgement'] = {id = 32, words = 'judgement', icon_id = 32, description = 'throw a holy hammer to your target wich deals holy damage.', exhaustion = 2000, premium = false, type = 'Instant', icon = 32, mana = 30, level = 15, soul = 0, group = {[1] = 2000}, vocations = {2}},
   
    --Magician
    ['Frost Blast'] = {id = 40, words = 'frost blast', icon_id = 40, description = 'shoot 2 frost bolts that deal frost damage to your target and reduce its movement speed.', exhaustion = 2000, premium = false, type = 'Instant', icon = 40, mana = 35, level = 8, soul = 0, group = {[1] = 2000}, vocations = {1}},
    ...
    ['Ice Wall'] = {id = 56, words = 'ice wall', icon_id = 56, description = 'create a ice wall wich extends horizontally blocking paths and enemies.', exhaustion = 2000, premium = false, type = 'Instant', icon = 56, mana = 115, level = 42, soul = 0, group = {[1] = 2000}, vocations = {0}},
    ...
    ['Eruption'] = {id = 58, words = 'eruption', icon_id = 58, description = 'prepare a area for eruption, wich explodes after a quick delay dealing fire damage to all enemies reached.', exhaustion = 2000, premium = false, type = 'Instant', icon = 58, mana = 10, level = 10, soul = 0, group = {[1] = 2000}, vocations = {0}},
    ['Glacial Steps'] = {id = 59, words = 'glacial steps', icon_id = 59, description = 'leave a trail of ice traps while walking wich slow down enemies on contact.', exhaustion = 50000, premium = false, type = 'Instant', icon = 59, mana = 115, level = 42, soul = 0, group = {[1] = 2000}, vocations = {0}},
    ...
    ['Party Vitality'] = {id = 67, words = 'Party Vitality', icon_id = 67, description = 'increase the max health of you and your party members by 10% for 20 minutes.', exhaustion = 2000, premium = false, type = 'Instant', icon = 67, mana = 100, level = 60, soul = 0, group = {[3] = 2000}, vocations = {5}},
    ...
    ['Blood Wall'] = {id = 70, words = 'blood Wall', icon_id = 70, description = 'increase your defense stat and max hitpoints for 15 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 70, mana = 0, level = 90, soul = 0, group = {[3] = 2000}, vocations = {5}},
    ...
    --Nightblade
    ['Stealth'] = {id = 80, words = 'stealth', icon_id = 80, description = 'enter stealth for 2.5 seconds wich makes you invisible to enemies and damage.', exhaustion = 60000, premium = false, type = 'Instant', icon = 80, mana = 110, level = 40, soul = 0, group = {[1] = 5000}, vocations = {3}},
   ...
   --Stellar
    ...
    ['Magic Walls'] = {id = 107, words = 'magic walls', icon_id = 107, description = 'create a sequence of magic walls that block paths, each consecutive wall will be placed based on the direction you are facing at that moment.', exhaustion = 25000, premium = false, type = 'Instant', icon = 107, mana = 100, level = 60, soul = 0, group = {[3] = 1900}, vocations = {6,8}},
    ['Lunar Beam'] = {id = 108, words = 'lunar beam', icon_id = 108, description = 'create a beam of lunar light that deals energy damage.', exhaustion = 13000, premium = false, type = 'Instant', icon = 108, mana = 185, level = 60, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Aery Strikes'] = {id = 109, words = 'aery strikes', icon_id = 109, description = 'aery strikes the target 3 times in a row dealing holy damage.', exhaustion = 8000, premium = false, type = 'Instant', icon = 109, mana = 135, level = 70, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Full Moon'] = {id = 111, words = 'full moon', icon_id = 111, description = 'for the next 8 seconds starfall will trigger constantly on all nearby enemies.', exhaustion = 45000, premium = false, type = 'Instant', icon = 111, mana = 300, level = 100, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Moonlight'] = {id = 112, words = 'moonlight', icon_id = 112, description = 'strong heal, that heals your friendly target, this spell consumes 12% of your max mana.', exhaustion = 2000, premium = false, parameter = true, type = 'Instant', icon = 112, mana = 80, level = 27, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Holy Flare'] = {id = 113, words = 'holy flare', icon_id = 113, description = 'send a strong holy flare at your target and nearby enemies dealing holy damage and applying a short duration fear.', exhaustion = 10000, premium = false, type = 'Instant', icon = 113, mana = 140, level = 1, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Solar Blessing'] = {id = 114, words = 'solar blessing', icon_id = 114, description = 'Increase a friendly target max health by 65% for 8 seconds and heal them instantly for 50% of your max mana at the start and ending of spell.', exhaustion = 10000, parameter = true, premium = false, type = 'Instant', icon = 114, mana = 140, level = 1, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Astral Infusion'] = {id = 115, words = 'astral infusion', icon_id = 115, description = 'Bless you and all party members with a 3% critical hit chance for 20 minutes.', exhaustion = 2000, premium = false, type = 'Instant', icon = 115, mana = 50, level = 60, soul = 0, group = {[2] = 1900}, vocations = {6}},
    

    --Monk
    ['Lotus Kick'] = {id = 127, words = 'lotus kick', icon_id = 127, description = 'powerfull kick that pulls in and out enemies and grants you 2 random chi orbs.', exhaustion = 7000, premium = false, type = 'Instant', icon = 127, mana = 30, level = 40, soul = 0, group = {[3] = 0}, vocations = {7}},
    ['Adaptive Punch'] = {id = 128, words = 'adaptive punch', icon_id = 128, description = 'advance technique that adapts based on the current 2 chi orbs combination you have.', exhaustion = 10000, premium = false, type = 'Instant', icon = 128, mana = 80, level = 15, soul = 0, group = {[3] = 2000}, vocations = {7}},
    ['Fire Punch'] = {id = 129, words = 'fire punch', icon_id = 129, description = 'send a flaming fist at your target dealing fire damage and burning the target for 3 seconds.', exhaustion = 3000, premium = false, type = 'Instant', icon = 129, mana = 35, level = 8, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Ice Punch'] = {id = 130, words = 'ice punch', icon_id = 130, description = 'send a icy fist at your target dealing ice damage and freezing the target for 1 second.', exhaustion = 3000, premium = false, type = 'Instant', icon = 130, mana = 35, level = 8, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Life Punch'] = {id = 131, words = 'life punch', icon_id = 131, description = 'send a life fist at your target dealing physical damage and healing yourself.', exhaustion = 3000, premium = false, type = 'Instant', icon = 131, mana = 35, level = 8, soul = 0, group = {[2] = 1900}, vocations = {7}},
    ['Fist of Fire'] = {id = 132, words = 'fist of fire', icon_id = 132, description = 'after spending 2 fire chi orbs, send a flurry of blows wich deals fire damage.', exhaustion = 12000, premium = false, type = 'Instant', icon = 132, mana = 115, level = 42, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ['Volcanic Dash'] = {id = 133, words = 'volcanic dash', icon_id = 133, description = 'call the turtle spirit and dash to to your target dealing fire damage on impact.', exhaustion = 12000, premium = false, type = 'Instant', icon = 133, mana = 115, level = 42, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ...
    ['Mountain Stance'] = {id = 135, words = 'mountain stance', icon_id = 135, description = 'for the next 10 seconds reduce damage taken by 30% and increases your max health by 25%', exhaustion = 50000, premium = false, type = 'Instant', icon = 135, mana = 650, level = 1, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Zen Barrier'] = {id = 136, words = 'zen barrier', icon_id = 136, description = 'Place a serenity sphere on a chosen player for 8 seconds. Each time they take damage, the sphere absorbs the damage and instantly heals them for the same amount.', exhaustion = 45000, parameter = true, premium = false, type = 'Instant', icon = 136, mana = 500, level = 1, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Mystic Fist'] = {id = 137, words = 'mystic fist', icon_id = 137, description = 'spend any orb combination to cast a powerfull strike.', exhaustion = 8000, premium = false, type = 'Instant', icon = 137, mana = 150, level = 50, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Crane Stance'] = {id = 138, words = 'crane stance', icon_id = 138, description = 'adopt the crane stance to increase your and all party members attack speed by 5% for 20 minutes.', exhaustion = 20000, premium = false, type = 'Instant', icon = 138, mana = 650, level = 1, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Fist of Ice'] = {id = 139, words = 'fist of ice', icon_id = 139, description = 'after spending 2 ice chi orbs, send a flurry of blows wich deals ice damage and slows all enemies while being casted.', exhaustion = 12000, premium = false, type = 'Instant', icon = 139, mana = 115, level = 42, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ['Fist of Life'] = {id = 140, words = 'fist of life', icon_id = 140, description = 'after spending 2 life chi orbs, send a flurry of blows wich heals all reached allies while being casted.', exhaustion = 12000, premium = false, type = 'Instant', icon = 140, mana = 115, level = 42, soul = 0, group = {[2] = 3000}, vocations = {7}},
    
    --Druid
    ['Terra Strike'] = {id = 150, words = 'terra strike', icon_id = 150, description = 'send a terra strike at your target dealing earth damage on a small area.', exhaustion = 3000, premium = false, type = 'Instant', icon = 150, mana = 30, level = 8, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Life Bloom'] = {id = 152, words = 'life bloom', icon_id = 152, description = 'apply a powerfull bloom wich heals overtime you and all party members for 6 seconds. this spell will consume 25% of your max mana.', exhaustion = 6000, premium = false, type = 'Instant', icon = 152, mana = 0, level = 1, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Rejuvenation'] = {id = 153, words = 'rejuvenation', icon_id = 153, description = 'apply a rejuvenation effect to yourself wich heals overtime for 8 seconds.', exhaustion = 5000, premium = false, type = 'Instant', icon = 153, mana = 100, level = 40, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Insect Swarm'] = {id = 154, words = 'insect swarm', icon_id = 154, description = 'cast a swarm of insects to your target wich deals nature damage and applies a infection effect to all nerby enemies on wich it can spread.', exhaustion = 15000, premium = false, type = 'Instant', icon = 154, mana = 75, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Travel Form'] = {id = 155, words = 'travel form', icon_id = 155, description = 'turn into your travel form, wich allows you to move faster but unable to cast spells.', exhaustion = 2000, premium = false, type = 'Instant', icon = 155, mana = 60, level = 25, soul = 0, group = {[3] = 2000}, vocations = {8}},
    ['Carnivorous Vile'] = {id = 156, words = 'carnivorous vile', icon_id = 156, description = 'cast a carnivorous vile wich devours its target dealing earth damage, if your target was infected by poison/earth/nature it does extra damage.', exhaustion = 5500, premium = false, type = 'Instant', icon = 156, mana = 85, level = 30, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['living ground'] = {id = 157, words = 'living ground', icon_id = 157, description = 'place a restoring field on the ground wich heals all allies while they stand on it.', exhaustion = 10000, premium = false, type = 'Instant', icon = 157, mana = 200, level = 1, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Piercing Wave'] = {id = 159, words = 'piercing wave', icon_id = 159, description = 'send a piercing wave that deals physical damage.', exhaustion = 12000, premium = false, type = 'Instant', icon = 159, mana = 115, level = 42, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Bear Form'] = {id = 160, words = 'bear form', icon_id = 160, description = 'turn into your bear form, wich increases your max health by 100% , heals yourself but reduces your damage done by 50% and movement speed.', exhaustion = 20000, premium = false, type = 'Instant', icon = 160, mana = 60, level = 45, soul = 0, group = {[3] = 2000}, vocations = {8}},
    ['Bless of the Forest'] = {id = 161, words = 'bless of the forest', icon_id = 161, description = 'infuse you and all party members with the blessing of the forest wich restores 1% of max hp and max mana every 3 seconds for 20 minutes', exhaustion = 2000, premium = false, type = 'Instant', icon = 161, mana = 50, level = 20, soul = 0, group = {[3] = 2000}, vocations = {8}},
    ['Wrath of Nature'] = {id = 162, words = 'wrath of nature', icon_id = 162, description = 'cast a thunderstorm at your target position wich deals energy damage.', exhaustion = 30000, premium = false, type = 'Instant', icon = 162, mana = 420, level = 100, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Focus Healing'] = {id = 165, words = 'focus healing', icon_id = 165, description = 'strong heal, that heals your friendly target', exhaustion = 1000, parameter = true, premium = false, type = 'Instant', icon = 165, mana = 140, level = 20, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Ice Shatter'] = {id = 166, words = 'ice shatter', icon_id = 166, description = 'create a ice block wich deals ice damage and it shatters itself to deal ice damage to all enemies in its radius.', exhaustion = 5500, premium = false, type = 'Instant', icon = 166, mana = 85, level = 30, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Frost Armor'] = {id = 168, words = 'frost armor', icon_id = 168, description = 'cast a frost armor wich reduces damage taken by 20% for 8 seconds.', exhaustion = 5500, premium = false, type = 'Instant', icon = 168, mana = 85, level = 30, soul = 0, group = {[1] = 1900}, vocations = {8}},

    --light dancer
    ['Charged Strike'] = {id = 170, words = 'charged strike', icon_id = 170, description = 'strike the target with a energy charged strike, if the target is affected by static charge it will trigger a second time.', exhaustion = 3000, premium = false, type = 'Instant', icon = 170, mana = 25, level = 8, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Static Charge'] = {id = 171, words = 'static charge', icon_id = 171, description = 'apply a static charge to yourself wich deals energy damage over time.', exhaustion = 2200, premium = false, type = 'Instant', icon = 171, mana = 0, level = 15, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Light Dash'] = {id = 172, words = 'light dash', icon_id = 172, description = 'dash to the target position and deal energy damage on impact.', exhaustion = 6000, premium = false, type = 'Instant', icon = 172, mana = 65, level = 18, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Veil of Swords'] = {id = 174, words = 'veil of swords', icon_id = 174, description = 'slash at lightning speed multiple times around yourself dealing physical damage.', exhaustion = 15000, premium = false, type = 'Instant', icon = 174, mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Magnetic Shield'] = {id = 175, words = 'magnetic shield', icon_id = 175, description = 'gain damage immunity for 5 seconds to all damage types but reduce your damage done by 80%', exhaustion = 45000, premium = false, type = 'Instant', icon = 175, mana = 115, level = 1, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Lightning Spear'] = {id = 176, words = 'lightning spear', icon_id = 176, description = 'send a lightning spear to the target that deals energy damage to all nearby enemies and also applies a static charge on impact.', exhaustion = 12000, premium = false, type = 'Instant', icon = 176, mana = 85, level = 30, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Overcharge'] = {id = 177, words = 'overcharge', icon_id = 177, description = 'gain a temporary 40% boost to your offensive skills for 8 seconds.', exhaustion = 30000, premium = false, type = 'Instant', icon = 177, mana = 115, level = 45, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Elusive Blade'] = {id = 178, words = 'elusive blade', icon_id = 178, description = 'slash your target with a strong strike dealing physical damage.', exhaustion = 35000, premium = false, type = 'Instant', icon = 178, mana = 175, level = 90, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Magnetic Orb'] = {id = 179, words = 'magnetic orb', icon_id = 179, description = 'create a magnetic orb at your target position that deals energy damage to all nearby enemies on its path.', exhaustion = 26000, premium = false, type = 'Instant', icon = 179, mana = 190, level = 100, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Tempest Coin'] = {id = 180, words = 'tempest coin', icon_id = 180, description = 'toss a tempest coin in the air that will grant you Tempest Charges, Tempest charges will determine the times charged strike will be triggered on next cast based on token results (1-3)', exhaustion = 22000, premium = false, type = 'Instant', icon = 180, mana = 115, level = 1, soul = 0, group = {[1] = 0}, vocations = {9}},
