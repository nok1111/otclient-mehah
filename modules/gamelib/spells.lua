...
SpellInfo = {
  ['Custom'] = {
    ...
    -- Dragon Knight
    ['Rend'] = {id = 1, words = 'rend', icon = 1, description = 'rend the target dealing physical damage and reaching nearby enemies. While Bloodlust is active, Rend applies bleed to all nearby enemies.', exhaustion = 3000, premium = false, type = 'Instant', mana = 15, level = 1, soul = 0, group = {[1] = 1900}, vocations = {4}},
    ['Brutal Swing'] = {id = 2, words = 'brutal swing', icon = 2, description = 'smash the target dealing high ammounts of physical damage, the targeted area can vary based on one handed or two handed weapon. While Bloodlust is active, Brutal Swing hits all nearby enemies. Rebound Strike has a chance to reset Rend cooldown.', exhaustion = 7000, premium = false, type = 'Instant', mana = 60, level = 38, soul = 0, group = {[1] = 1900}, vocations = {4}},
    ...
    ['Draconic Chains'] = {id = 11, words = 'draconic chains', icon = 11, description = 'unleash your dragon chains pulling all enemies into you, dealing physical damage and applying a fire burn over time. [magic]', exhaustion = 18000, premium = false, type = 'Instant', mana = 300, level = 1, soul = 0, group = {[3] = 1900}, vocations = {4}, needLearn = true},
    ['Seismic Jump'] = {id = 12, words = 'seismic jump', icon = 12, description = 'leap to a target location, dealing physical damage and knocking enemies into the air on landing. [skill+attack]', exhaustion = 10000, premium = false, type = 'Instant', mana = 40, level = 1, soul = 0, group = {[1] = 1900}, vocations = {4}, needLearn = true, crosshair = true, area = 'AREA_SEISMIC_JUMP', range = 7, areaSprite = 1178},
    ...
    ['Energy Blast'] = {id = 41, words = 'energy blast', icon = 41, description = 'cast a energy blast wich restore mana on impact and deals energy damage to your target. At max Arcane Momentum stacks (Arcanist keystone), the next cast is free and fires an additional Arcane Missile.', exhaustion = 3000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {1}},
    ...
    ['Ice Nova'] = {id = 44, words = 'ice nova', icon = 44, description = 'create a ice nova wich extends from your current position slowing all enemies in its radius.', exhaustion = 25000, premium = false, type = 'Instant', mana = 115, level = 38, soul = 0, group = {[1] = 1900}, vocations = {1}, needLearn = true},
    ['Mana Distortion'] = {id = 46, words = 'mana distortion', icon = 46, description = 'creates a distortion field wich increases magic level by 20% and restore mana to allies who stand inside its radius', exhaustion = 120000, premium = false, type = 'Instant', mana = 0, level = 100, soul = 0, group = {[3] = 1900}, vocations = {1}, needLearn = true},
    ...
    ['Soul Rain'] = {id = 74, words = 'soul rain', icon = 74, description = 'cast a rain of death over your target position dealing death damage over 8 seconds. Only affects enemies afflicted by Curse.', exhaustion = 45000, premium = false, type = 'Instant', mana = 200, level = 80, soul = 0, group = {[1] = 2000}, vocations = {5}, crosshair = true, area = 'AREA_CIRCLE3X3', range = 7, areaSprite = 1178},
    ...
    ['Haunt'] = {id = 77, words = 'haunt', icon = 77, description = 'haunts the target and apply a curse to it and nearby enemies after impact wich last 10 seconds. Deals 100% increased damage to targets already afflicted by a curse. Consumes 20% of your maximum mana to cast.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 2000}, vocations = {5}, needLearn = true},
    ...
    --Nightblade
    ['Stealth'] = {id = 80, words = 'stealth', icon = 80, description = 'enter stealth for 2.5 seconds wich makes you invisible to enemies and damage. With Blur, your first attack from stealth gains bonus crit chance and damage.', exhaustion = 60000, premium = false, type = 'Instant', mana = 110, level = 80, soul = 0, group = {[3] = 5000}, vocations = {3}},
   ...
   --Stellar
    ...
    ['Living Thorns'] = {id = 163, words = 'living thorns', icon = 163, description = 'unleash a wave of thorns forward, dealing earth damage to enemies in a 3-tile wide line.', exhaustion = 12000, premium = false, type = 'Instant', mana = 200, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true, direction = true},
    ...
    ['Phantom Shot'] =              {id = 190, words = 'phantom shot', icon = 190, exhaustion = 6000, premium = false, type = 'Instant', mana = 35, level = 1, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots a phantom shot at the target, dealing high damage. Hunter Mercy: executes targets below 5% HP per level and resets cooldown on kill. Apex Predator: kills reset this spell cooldown. [Weapon Damage, DISTANCE]',needLearn = true},
    ...
    ['Rapid Fire'] =                {id = 192, words = 'rapid fire', icon = 192, exhaustion = 6000, premium = false, type = 'Instant', mana = 55, level = 38, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots a rapid succession of arrows at the target. Focused Fire: +4% damage per level per debuff on target (slow, burn, bleed, freeze). [Weapon Damage, DISTANCE]'},
    ...
    ['Falcon Shot'] =               {id = 194, words = 'falcon shot', icon = 194, exhaustion = 13000, premium = false, type = 'Instant', mana = 120, level = 1, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots a falcon shot at the target, dealing high damage. Focused Fire: +4% damage per level per debuff on target (slow, burn, bleed, freeze). [Weapon Damage, DISTANCE]',needLearn = true},
    

    --others
    ['Shield Wall'] = {id = 203, words = 'shield wall', icon = 204, description = 'Increase your defense skill and block value by 30%, requires a shield or offhand to be equiped.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[2] = 2000}, vocations = {2,4,15}},
    ['Taunt'] = {id = 220, words = 'taunt', icon = 220, description = 'Taunt all nearby enemies forcing them to attack you.', exhaustion = 2000, premium = false, type = 'Instant', mana = 20, level = 1, soul = 0, group = {[2] = 1900}, vocations = {2,4,7,15}},
    ...
    ['Magic Shield'] = {id = 208, words = 'magic shield', icon = 208, description = 'Creates a protective barrier that absorbs damage.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[2] = 2000}, vocations = {1,5,8,6}},
    ...
    --Samurai
    ['Rending Slash'] = {id = 250, words = 'rending slash', icon = 287, description = 'Strike your target with a quick slash dealing physical damage. Builder: {generates 1 Focus, #5dade2} stack.', exhaustion = 3000, premium = false, type = 'Instant', mana = 15, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Triple Slash'] = {id = 257, words = 'triple slash', icon = 293, description = 'Perform 1 to 3 rapid slashes on the target (1 + Focus stacks). Finisher: each strike scales with Focus. Consumes Exposed for +10-30% damage. {Consumes all Focus., #2e86c1}', exhaustion = 8000, premium = false, type = 'Instant', mana = 30, level = 8, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Wind Step'] = {id = 252, words = 'wind step', icon = 317, description = 'Dash up to 5 tiles in a straight line, damaging enemies along the path. Combo: next Iaijutsu within 4s costs 0 Focus and deals +30% damage. Flowing Water: next attack deals +15% and {generates +1 Focus., #5dade2} Storm Spirit: +20% attack speed, +15% CDR, and attacks splash for 5s.', exhaustion = 8000, premium = false, type = 'Instant', mana = 25, level = 20, soul = 0, group = {[3] = 1900}, vocations = {13}, crosshair = true, area = 'WIND_STEP', range = 5, areaSprite = 1178},
    ['Blade Tempest'] = {id = 251, words = 'blade tempest', icon = 289, description = 'Unleash a circular fan of blades around you dealing physical damage to all nearby enemies. Builder: {generates 1 Focus, #5dade2} stack.', exhaustion = 8000, premium = false, type = 'Instant', mana = 40, level = 38, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Guardian Stance'] = {id = 253, words = 'guardian stance', icon = 310, description = 'Enter a defensive stance for 5s +2.5s per Focus: +50% shield, +20% dodge, +15% block, and heals 5% per Focus. Synergy: {generates 1 Focus, #5dade2} per second when hit while active. Fortress: reflects 50% melee damage and {generates 1 Focus/s., #5dade2}', exhaustion = 18000, premium = false, type = 'Instant', mana = 50, level = 53, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Iaijutsu'] = {id = 254, words = 'iaijutsu', icon = 318, description = 'Draw your blade with blinding speed, cutting all enemies in a frontal cone for heavy physical damage. Finisher: +35% damage per Focus stack. Synergy: after Wind Step, {costs 0 Focus, #5dade2} and deals +30%. Consumes bleeds for +20%. Consumes Exposed for +10-30%.', exhaustion = 12000, premium = false, type = 'Instant', mana = 50, level = 60, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Crimson Lotus'] = {id = 255, words = 'crimson lotus', icon = 319, description = 'Unleash a crimson lotus in a frontal cone, dealing physical damage and applying bleed. Finisher: +20% damage per Focus stack. Bleed scales with Focus. Bloodletting: +2s duration and +10% bleed damage per level. Consumes Exposed from all targets. {Consumes all Focus., #2e86c1}', exhaustion = 20000, premium = false, type = 'Instant', mana = 80, level = 70, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Merciful End'] = {id = 256, words = 'merciful end', icon = 315, description = 'Execute a wounded target. Finisher: deals massive bonus damage below 25% HP threshold (+5% per Executioners Edge level). Synergy: bleeding targets get +10% threshold and +50% execute damage. Death Mark: +10% threshold and +15% damage. Exposed: consumed for +10-30%. {Consumes all Focus., #2e86c1}', exhaustion = 25000, premium = false, type = 'Instant', mana = 60, level = 80, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['War Cry'] = {id = 291, words = 'war cry', icon = 314, description = 'Grant +10% damage to yourself and nearby party members for 8 seconds. Support spell that complements any build.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 30, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Death Mark'] = {id = 292, words = 'death mark', icon = 61, description = 'Mark a monster for 8 seconds. Marked targets take +20% damage from all your attacks. Synergy: Merciful End gets +10% execute threshold and +15% damage on marked targets.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}, range = 4},
    ['Phantom Slash'] = {id = 293, words = 'phantom slash', icon = 311, description = 'Dash through all enemies in a line up to 4 tiles, dealing physical damage to each. Leaves after-images along the path.', exhaustion = 6000, premium = false, needLearn = true, type = 'Instant', mana = 35, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Second Wind'] = {id = 294, words = 'second wind', icon = 65, description = 'Instantly heal 30% max HP + 20% per Focus stack consumed. {Consumes all Focus., #2e86c1}', exhaustion = 20000, premium = false, needLearn = true, type = 'Instant', mana = 50, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Blade Dash'] = {id = 295, words = 'blade dash', icon = 309, description = 'Strike a target up to 3 tiles away, dash through them, and heal for 25% of damage dealt. Stuns and knocks up enemies around the target for 1s. Mobility + sustain + control spell.', exhaustion = 8000, premium = false, needLearn = true, type = 'Instant', mana = 30, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}, range = 3},
    ['Meditation'] = {id = 297, words = 'meditation', icon = 294, description = 'Channel for 1 second to instantly {gain 3 Focus, #5dade2} stacks. Respects Focus Mastery (up to 6 max).', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 25, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},
    ['Blade Flurry'] = {id = 298, words = 'blade flurry', icon = 293, description = 'Strike a target 3 times in rapid succession, dealing physical damage. The final hit applies Exposed (max 3 stacks, 8s). Exposed targets take +10% damage from finishers per stack. Builder: {generates 1 Focus, #5dade2} stack.', exhaustion = 3500, premium = false, needLearn = true, type = 'Instant', mana = 20, level = 1, soul = 0, group = {[1] = 1900}, vocations = {13}},
    ['Counter Strike'] = {id = 299, words = 'counter strike', icon = 297, description = 'Passive: while Guardian Stance is active, you have a chance to automatically counter-attack when hit, dealing physical damage and {generating 1 Focus., #5dade2} Chance: 10% base + 3% per Parry level.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[3] = 1100}, vocations = {13}},


        --Blood Mage
    ['Sanguine Bolt'] = {id = 260, words = 'sanguine bolt', icon = 248, description = 'Fire a blood bolt at your target dealing physical damage. {Costs 2% max HP., #e74c3c} {Generates 12 Blood Essence., #c0392b} +8% damage per {Blood Orb, #8b0000} held. If Crimson Sigil is active, 25% chance to apply a bleed for 3 ticks.', exhaustion = 2000, premium = false, type = 'Instant', mana = 0, hpCost = 2, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Siphon'] = {id = 261, words = 'blood siphon', icon = 249, description = 'Send multiple blood missiles at your target dealing death damage. {Generates Blood Essence, #c0392b} per missile hit. Heals you based on your level, max HP and magic level.', exhaustion = 5000, premium = false, type = 'Instant', mana = 0, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Crimson Sigil'] = {id = 262, words = 'crimson sigil', icon = 253, description = '{Spends 50 Blood Essence, #c0392b} to activate Crimson Sigil for 12 seconds. +20% damage, +10% heal bonus, and Sanguine Bolt gains 25% chance to apply bleed. {Costs 5% max HP., #e74c3c}', exhaustion = 18000, premium = false, type = 'Instant', mana = 0, hpCost = 5, level = 22, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Blood Threads'] = {id = 263, words = 'blood threads', icon = 250, description = 'Unleash crimson threads in a cone before you, dealing physical damage and applying a curse to all enemies hit that deals death damage over time. {Costs 8% max HP., #e74c3c} {Generates 25 Blood Essence., #c0392b} {Generates 1 Blood Orb, #8b0000} if cast during {Blood Frenzy., #e67e22}', exhaustion = 8000, premium = false, type = 'Instant', mana = 0, hpCost = 8, level = 38, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Eruption'] = {id = 265, words = 'blood eruption', icon = 259, description = 'Erupt in a large AoE dealing death damage. Consumes all active bleeds and curses on targets hit: +20% damage per effect consumed. Heals 5% max HP per bleed/curse consumed (cap 30%). {Consumes ALL Blood Orbs, #8b0000} for +5% max HP heal each. {Generates 15 Blood Essence., #c0392b} {Costs 10% max HP., #e74c3c}', exhaustion = 10000, premium = false, type = 'Instant', mana = 0, hpCost = 10, level = 60, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 260, description = 'Infect a target with a powerful death damage DoT for 6 seconds that heals you for 30% of damage dealt. While cursed, the target takes +25% damage from ALL damage-over-time effects (any class). {Generates 8 Blood Essence per tick., #c0392b} Scales with Bleed & Curse Mastery and Risk Multiplier. {Costs 4% max HP., #e74c3c}', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 4, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Blood Plague'] = {id = 314, words = 'blood plague', icon = 58, description = 'Curse your target with a spreading blood plague that leaves a bleeding wound dealing death damage over 8 seconds (1 tick per second). Each tick spreads the plague to one nearby uninfected enemy within 3 tiles (max 5 spreads). Infected targets count as bleeding for Blood Eruption. {Generates 2 Blood Essence per tick., #c0392b} {Costs 6% max HP., #e74c3c}', exhaustion = 10000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 6, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Sanguine Shield'] = {id = 300, words = 'sanguine shield', icon = 70, description = 'For 5 seconds, 20% of incoming damage is converted to {Blood Essence, #c0392b} instead of dealing damage. {Costs 2% max HP., #e74c3c}', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 2, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Vampiric Aura'] = {id = 301, words = 'vampiric aura', icon = 256, description = 'For 30 minutes, all party members gain 5% lifesteal. {Costs 3% max HP., #e74c3c}', exhaustion = 30000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Walk'] = {id = 302, words = 'blood walk', icon = 251, description = 'Teleport to a bleeding target within 6 tiles, dealing AoE damage on arrival. {Consumes 1 Blood Orb, #8b0000} for +50% damage and applies a bleed to nearby enemies. {Costs 2% max HP., #e74c3c}', exhaustion = 6000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 2, level = 1, soul = 0, group = {[3] = 1900}, vocations = {14}},
    ['Crimson Chains'] = {id = 303, words = 'crimson chains', icon = 264, description = 'Root all enemies within 3 tiles for 3 seconds. {Costs 3% max HP., #e74c3c}', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Blood Ritual'] = {id = 304, words = 'blood ritual', icon = 274, description = 'Toggle: sacrifice 5% HP per second for {10 Blood Essence per second., #c0392b} Cast again to toggle off.', exhaustion = 1000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 5, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ['Exsanguinate'] = {id = 312, words = 'exsanguinate', icon = 265, description = 'Strike your target dealing heavy death damage. +50% damage if target is below 30% HP. {Consumes ALL Blood Orbs, #8b0000} for +10% damage each. Heals you based on your level, max HP and magic level. Sanguine Strike: on kill or execute, refunds Blood Orbs.', exhaustion = 15000, premium = false, type = 'Instant', mana = 0, hpCost = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
    ['Bat Form'] = {id = 305, words = 'bat form', icon = 70, description = 'Transform into a bat for 15 seconds. +40% movement speed, 50% dodge chance, and heal 2% max HP per second. Cast again to cancel. {Costs 3% max HP., #e74c3c}', exhaustion = 2000, premium = false, needLearn = true, type = 'Instant', mana = 0, hpCost = 3, level = 1, soul = 0, group = {[3] = 1100}, vocations = {14}},
    ...
    ['Grenade Toss'] = {id = 321, words = 'grenade toss', icon = 321, description = 'Lob a grenade at the target dealing physical damage in a 5x5 area. +5% damage per Scrap. Consumes 2 Scrap.', exhaustion = 0, premium = false, type = 'Instant', mana = 30, level = 12, soul = 0, group = {[1] = 1900}, vocations = {12}},
    ['Deploy Scout'] = {id = 322, words = 'deploy scout', icon = 322, description = 'Deploy a Scout Bot that fights for you. Max 2 robots at once.', exhaustion = 8000, premium = false, type = 'Instant', mana = 40, level = 8, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Deploy Mini Tank'] = {id = 323, words = 'deploy tank', icon = 323, description = 'Deploy a Mini Tank with high HP and strong resistances. Mobile ranged tank.', exhaustion = 15000, premium = false, type = 'Instant', mana = 50, level = 25, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Repair'] = {id = 324, words = 'repair', icon = 341, description = 'Heal yourself. +10% healing per Scrap. Consumes 1 Scrap.', exhaustion = 6000, premium = false, type = 'Instant', mana = 35, level = 15, soul = 0, group = {[2] = 1100}, vocations = {12}},
    ['Repair Bots'] = {id = 343, words = 'repair bots', icon = 325, description = 'Heal all active robots based on your stats. +10% healing per Scrap. Consumes 1 Scrap.', exhaustion = 8000, premium = false, type = 'Instant', mana = 45, level = 30, soul = 0, group = {[2] = 1100}, vocations = {12}},
    ['Rocket Boots'] = {id = 325, words = 'rocket boots', icon = 326, description = 'Dash up to 8 tiles in the target direction.', exhaustion = 10000, premium = false, type = 'Instant', mana = 25, level = 25, soul = 0, group = {[3] = 1100}, vocations = {12}, crosshair = true, area = 'ROCKET_BOOTS', range = 8, areaSprite = 1178},
    ['Overclock'] = {id = 326, words = 'overclock', icon = 327, description = 'Consume 3 Scrap to gain +25% attack speed and make spells cost no Scrap for 8 seconds.', exhaustion = 30000, premium = false, type = 'Instant', mana = 60, level = 35, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Mech Suite'] = {id = 344, words = 'mech suite', icon = 333, description = 'Transform into a mech: +20% damage and attack speed to self and bots for 15s. Apex Mech: +3s, bot atk speed +20%, shield 15% max HP, cleanse.', exhaustion = 60000, premium = false, type = 'Instant', mana = 80, level = 35, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Deploy War Bot'] = {id = 327, words = 'deploy warbot', icon = 328, description = 'Deploy a heavy War Bot with high HP and taunting capabilities. Robotics specialization.', exhaustion = 12000, premium = false, type = 'Instant', mana = 70, level = 1, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Deploy Laser Drone'] = {id = 345, words = 'deploy laserdrone', icon = 329, description = 'Deploy a Laser Drone that fires an energy laser at targets (range 4). Robotics talent unlock.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 60, level = 1, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Land Mine'] = {id = 340, words = 'land mine', icon = 336, description = 'Place a hidden mine at the target location that explodes when enemies step on it. Max 3 mines. Lasts 60 seconds. Demolition specialization.', exhaustion = 12000, premium = false, type = 'Instant', mana = 40, level = 20, soul = 0, group = {[3] = 1100}, vocations = {12}, crosshair = true, area = 'AREA_MINE', range = 5, areaSprite = 1178},
    ['Deploy Med Bot'] = {id = 341, words = 'deploy medbot', icon = 330, description = 'Deploy a Med Bot that heals you and nearby allies. Engineering specialization.', exhaustion = 15000, premium = false, type = 'Instant', mana = 60, level = 1, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Deploy Kitty Bot'] = {id = 346, words = 'deploy kittybot', icon = 342, description = 'Deploy a Kitty Bot — fast melee bot with rapid slash attacks. Robotics talent unlock.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 55, level = 1, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ['Deploy Barrier Bot'] = {id = 347, words = 'deploy barrierbot', icon = 332, description = 'Deploy a Barrier Bot that casts shields on allies in range. Engineering talent unlock.', exhaustion = 15000, premium = false, needLearn = true, type = 'Instant', mana = 65, level = 1, soul = 0, group = {[3] = 1100}, vocations = {12}},
    ...
    -- Bard
    ['Cheerful Melody'] = {id = 270, words = 'cheerful melody', icon = 228, description = 'Aura: heals player and nearby allies every 1.5s. Cheerful Cleansing: cleanses conditions on entry. +12 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 30, level = 8, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Pensive Melody'] = {id = 271, words = 'pensive melody', icon = 236, description = 'Aura: mana regen. Burst: AoE mana restore on cast. +10 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 25, level = 38, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Menacing Melody'] = {id = 272, words = 'menacing melody', icon = 235, description = 'Aura: enemies +15% damage taken. Burst: 1.5s stun on resonating enemies only. Apply Resonance first to trigger the stun. +12 {Harmony,#d23cff}.', exhaustion = 12000, premium = false, type = 'Instant', mana = 35, level = 45, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Cathartic Melody'] = {id = 273, words = 'cathartic melody', icon = 223, description = 'Aura: +15% damage output. Burst: energy damage on resonating enemies (+50%), consumes their Resonance. +14 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 40, level = 53, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Epic Melody'] = {id = 274, words = 'epic melody', icon = 229, description = 'Aura: +30 movement speed. Burst: instant speed on cast. +8 {Harmony,#d23cff}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 20, level = 60, soul = 0, group = {[3] = 1900}, vocations = {11}},
    ['Echo Strike'] = {id = 275, words = 'echo strike', icon = 232, description = 'Single target damage. Applies Resonance (6s base, +1s per Lingering Resonance level). Resonating enemies emit a small sonic wave when hit (0.5s cd). +10 {Dissonance,#ffc832}.', exhaustion = 4000, premium = false, type = 'Instant', mana = 15, level = 1, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Resonant Chorus'] = {id = 276, words = 'resonant chorus', icon = 245, description = 'Ranged AoE damage centered on target. If the target has Resonance, it propagates to all nearby non-resonating enemies. If not, the target becomes Resonating. +12 {Dissonance,#ffc832}.', exhaustion = 8000, premium = false, type = 'Instant', mana = 30, level = 38, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Discordant Verse'] = {id = 277, words = 'discordant verse', icon = 247, description = 'High single target damage. Against resonating targets: bonus damage and reduces target damage dealt for 5s. Does not consume Resonance. +14 {Dissonance,#ffc832}.', exhaustion = 10000, premium = false, type = 'Instant', mana = 45, level = 45, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Harmonic Collapse'] = {id = 278, words = 'harmonic collapse', icon = 231, description = 'Detonates all nearby resonating enemies. Overlapping explosions boost each other by +10% (max +50%). Consumes Resonance. +18 {Dissonance,#ffc832}.', exhaustion = 12000, premium = false, type = 'Instant', mana = 70, level = 60, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Reverberation'] = {id = 280, words = 'reverberation', icon = 240, description = 'Shield for 30% max HP + 3% per nearby resonating enemy. Lasts 6s. Reverb Cascade: shares shield (50%) with 1 party member per level and +1% max HP per resonating enemy per level. +10 {Harmony,#d23cff}.', exhaustion = 15000, premium = false, type = 'Instant', mana = 60, level = 53, soul = 0, group = {[1] = 1900}, vocations = {11}},
    ['Grand Finale'] = {id = 279, words = 'grand finale', icon = 226, description = 'Requires {Dissonance,#ffc832} or {Harmony,#d23cff} at 100%. {Dissonance,#ffc832}: Apocalypse Crescendo - massive holy AoE + debuff enemies. Leaves you vulnerable (+50% damage taken) for 5s. {Harmony,#d23cff}: Elysian Symphony - party heal + cleanse + defense. Resets {Dissonance,#ffc832}/{Harmony,#d23cff} to 50. Finale Mastery: +4% CDR per level for 10s. Virtuoso\'s Finale: replica at 50% power 6s later.', exhaustion = 30000, premium = false, type = 'Instant', mana = 120, level = 80, soul = 0, group = {[1] = 1900}, vocations = {11}},
