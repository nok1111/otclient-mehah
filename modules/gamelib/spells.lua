...
SpellInfo = {
  ['Custom'] = {
    ...
    ['Mana Distortion'] = {id = 46, words = 'mana distortion', icon_id = 46, description = 'creates a distortion field wich increases magic level by 20% and restore mana to allies who stand inside its radius', exhaustion = 120000, premium = false, type = 'Instant', icon = 46, mana = 0, level = 100, soul = 0, group = {[3] = 1900}, vocations = {1}},
    ...
    ['Arcane Missiles'] = {id = 51, words = 'arcane missiles', icon_id = 51, description = 'shoot a group of missiles wich deals energy damage to your target.', exhaustion = 4000, premium = false, type = 'Instant', icon = 51, mana = 130, level = 38, soul = 0, group = {[1] = 1900}, vocations = {1}, needLearn = true},
    ...
    ['Ice Wall'] = {id = 56, words = 'ice wall', icon_id = 56, description = 'create a ice wall wich extends horizontally blocking paths and enemies.', exhaustion = 12000, premium = false, type = 'Instant', icon = 56, mana = 200, level = 70, soul = 0, group = {[3] = 1900}, vocations = {1}},
    ...
    ['Eruption'] = {id = 58, words = 'eruption', icon_id = 58, description = 'prepare a area for eruption, wich explodes after a quick delay dealing fire damage to all enemies reached.', exhaustion = 4000, premium = false, type = 'Instant', icon = 58, mana = 140, level = 60, soul = 0, group = {[1] = 1900}, vocations = {1}},
    ...
    --Warlock
    ['Zombie Wall'] = {id = 61, words = 'zombie wall', icon_id = 61, description = 'create a zombie wall wich extends horizontally 2 tiles from your current position.', exhaustion = 20000, premium = false, type = 'Instant', icon = 61, mana = 80, level = 1, soul = 0, group = {[3] = 1900}, vocations = {5}, needLearn = true},
    ...
    ['Fear'] = {id = 63, words = 'fear', icon_id = 63, description = 'fear your target for 6 seconds wich makes it unable to control itself.', exhaustion = 30000, premium = false, type = 'Instant', icon = 63, mana = 150, level = 70, soul = 0, group = {[3] = 1900}, vocations = {5}},
    ['Shadow Strike'] = {id = 64, words = 'shadow strike', icon_id = 64, description = 'send a shadow bolt to your target dealing shadow damage.', exhaustion = 7000, premium = false, type = 'Instant', icon = 64, mana = 65, level = 38, soul = 0, group = {[1] = 1900}, vocations = {5}},
    ['Summon Void Mender'] = {id = 65, words = 'summon void mender', icon_id = 65, description = 'summon a void mender wich heals injured allies or summons.', exhaustion = 5000, premium = false, type = 'Instant', icon = 65, mana = 300, level = 1, soul = 0, group = {[3] = 1900}, vocations = {5}, needLearn = true},
    ['Blood Pact'] = {id = 66, words = 'blood pact', icon_id = 66, description = 'exchage a percentage of your max health for mana.', exhaustion = 1500, premium = false, type = 'Instant', icon = 66, mana = 0, level = 60, soul = 0, group = {[2] = 0}, vocations = {5}},
    ...
    ['Malediction'] = {id = 76, words = 'malediction', icon_id = 76, description = 'cast a strong plague to your target that deals death damage on impact.', exhaustion = 8000, premium = false, type = 'Instant', icon = 76, mana = 150, level = 1, soul = 0, group = {[1] = 2000}, vocations = {5}, needLearn = true},
    ['Haunt'] = {id = 77, words = 'haunt', icon_id = 77, description = 'haunts the target and apply a curse to it and nearby enemies after impact wich last 10 seconds.', exhaustion = 2000, premium = false, type = 'Instant', icon = 77, mana = 250, level = 70, soul = 0, group = {[1] = 2000}, vocations = {5}, needLearn = true},
    ['Dark Aura'] = {id = 78, words = 'dark aura', icon_id = 78, description = 'infuse yourself with a dark aura that reduce all damage taken by 25%.', exhaustion = 2000, premium = false, type = 'Instant', icon = 78, mana = 0, level = 1, soul = 0, group = {[3] = 2000}, vocations = {5}, needLearn = true},
   
    --Nightblade
    ['Stealth'] = {id = 80, words = 'stealth', icon_id = 80, description = 'enter stealth for 2.5 seconds wich makes you invisible to enemies and damage.', exhaustion = 60000, premium = false, type = 'Instant', icon = 80, mana = 110, level = 85, soul = 0, group = {[3] = 5000}, vocations = {3}},
    ...
    ['Shadow Hunt'] = {id = 82, words = 'shadow hunt', icon_id = 82, description = 'cast a hunting blade over your target that deals shadow damage 4 times in a row.', exhaustion = 6000, premium = false, type = 'Instant', icon = 82, mana = 60, level = 38, soul = 0, group = {[1] = 1900}, vocations = {3}},
    ['Shadowstep'] = {id = 83, words = 'shadowstep', icon_id = 83, description = 'shadow step before your target appearing behind it and stuning it for a small duration.', exhaustion = 20000, premium = false, type = 'Instant', icon = 83, mana = 50, level = 70, soul = 0, group = {[3] = 1900}, vocations = {3}},
    ['Backstab'] = {id = 84, words = 'backstab', icon_id = 84, description = 'backstab your target dealing physical damage wich stuns it for 2 seconds.', exhaustion = 8000, premium = false, type = 'Instant', icon = 84, mana = 50, level = 53, soul = 0, group = {[1] = 0}, vocations = {3}},
    ['Assassination'] = {id = 85, words = 'assassination', icon_id = 85, description = 'assassinate all nearby enemies teleporting you into them for a breaf period of time making you untargetable.', exhaustion = 22000, premium = false, type = 'Instant', icon = 85, mana = 250, level = 1, soul = 0, group = {[1] = 1900}, vocations = {3}, needLearn = true},
    ['Fan of Knives'] = {id = 86, words = 'fan of knives', icon_id = 86, description = 'sprays knives at all enemies around your dealing physical damage and applie a poison effect.', exhaustion = 5000, premium = false, type = 'Instant', icon = 86, mana = 120, level = 60, soul = 0, group = {[1] = 1900}, vocations = {3}},
    ['Shadow Form'] = {id = 87, words = 'shadow form', icon_id = 87, description = 'enter a shadow state that heals you for the duration.', exhaustion = 30000, premium = false, type = 'Instant', icon = 87, mana = 65, level = 80, soul = 0, group = {[3] = 3000}, vocations = {3}},
    ['Dark Rupture'] = {id = 88, words = 'dark rupture', icon_id = 88, description = 'create a rupture into your target wich deals physical damage, if the target is stunned it will apply a bleeding effect.', exhaustion = 7000, premium = false, type = 'Instant', icon = 88, mana = 50, level = 45, soul = 0, group = {[1] = 1900}, vocations = {3}},
    ['Void Execution'] = {id = 89, words = 'void execution', icon_id = 89, description = 'executes all nearby enemies while their health is below 30%, this effect is changed to 20% for players.', exhaustion = 22000, premium = false, type = 'Instant', icon = 89, mana = 200, level = 1, soul = 0, group = {[1] = 1900}, vocations = {3}, needLearn = true},
    ['Blood Blades'] = {id = 90, words = 'blood blades', icon_id = 90, description = 'enter a bloody state wich heals you everytime you land a melee hit.', exhaustion = 25000, premium = false, type = 'Instant', icon = 90, mana = 0, level = 80, soul = 0, group = {[3] = 1900}, vocations = {3}},
    ['Lethal Dagger'] = {id = 91, words = 'lethal dagger', icon_id = 91, description = 'throw a lethal dagger at your target dealing physical damage.', exhaustion = 4000, premium = false, type = 'Instant', icon = 91, mana = 50, level = 35, soul = 0, group = {[1] = 0}, vocations = {3}},
    ['Blackout'] = {id = 92, words = 'blackout', icon_id = 92, description = 'hit your target with a dark force stunnin it for 4 seconds.', exhaustion = 16000, premium = false, type = 'Instant', icon = 92, mana = 0, level = 1, soul = 0, group = {[1] = 0}, vocations = {3}, needLearn = true},
   ...
   --Stellar
    ...
    ['Aery Wrath'] = {id = 102, words = 'aery wrath', icon_id = 102, description = 'send aery into combat making her travel through your target and all enemies around it dealing holy damage.', exhaustion = 15000, premium = false, type = 'Instant', icon = 102, mana = 160, level = 45, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Starfall'] = {id = 103, words = 'starfall', icon_id = 103, description = 'call a starfall over your target position dealing energy damage and restoring mana.', exhaustion = 5000, premium = false, type = 'Instant', icon = 103, mana = 0, level = 38, soul = 0, group = {[1] = 0}, vocations = {6}},
    ['Falling Star'] = {id = 104, words = 'falling star', icon_id = 104, description = 'call down a falling star over your target dealing damage and stunning it for 3 seconds..', exhaustion = 12000, premium = false, type = 'Instant', icon = 104, mana = 170, level = 60, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Rain fall'] = {id = 105, words = 'rain fall', icon_id = 105, description = 'create a safe zone where rain falls and heals all allies who stand in it.', exhaustion = 30000, premium = false, type = 'Instant', icon = 105, mana = 200, level = 53, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Magic Walls'] = {id = 107, words = 'magic walls', icon_id = 107, description = 'create a sequence of magic walls that block paths, each consecutive wall will be placed based on the direction you are facing at that moment.', exhaustion = 60000, premium = false, type = 'Instant', icon = 107, mana = 100, level = 80, soul = 0, group = {[3] = 1900}, vocations = {6}},
    ['Lunar Beam'] = {id = 108, words = 'lunar beam', icon_id = 108, description = 'create a beam of lunar light that deals energy damage.', exhaustion = 20000, premium = false, type = 'Instant', icon = 108, mana = 285, level = 80, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Aery Strikes'] = {id = 109, words = 'aery strikes', icon_id = 109, description = 'aery strikes the target 3 times in a row dealing holy damage.', exhaustion = 15000, premium = false, type = 'Instant', icon = 109, mana = 120, level = 70, soul = 0, group = {[1] = 1900}, vocations = {6}},
    ['Full Moon'] = {id = 111, words = 'full moon', icon_id = 111, description = 'for the next 8 seconds starfall will trigger constantly on all nearby enemies.', exhaustion = 90000, premium = false, type = 'Instant', icon = 111, mana = 300, level = 1, soul = 0, group = {[2] = 1900}, vocations = {6}, needLearn = true},
    ['Moonlight'] = {id = 112, words = 'moonlight', icon_id = 112, description = 'strong heal, that heals your friendly target, this spell consumes 12% of your max mana.', exhaustion = 2000, premium = false, parameter = true, type = 'Instant', icon = 112, mana = 100, level = 60, soul = 0, group = {[2] = 1900}, vocations = {6}},
    ['Holy Flare'] = {id = 113, words = 'holy flare', icon_id = 113, description = 'send a strong holy flare at your target and nearby enemies dealing holy damage and applying a short duration fear.', exhaustion = 17000, premium = false, type = 'Instant', icon = 113, mana = 220, level = 1, soul = 0, group = {[2] = 1900}, vocations = {6}, needLearn = true},
    ...
    --Monk
    ['Lotus Kick'] = {id = 127, words = 'lotus kick', icon_id = 127, description = 'powerfull kick that pulls in and out enemies and grants you 2 random chi orbs.', exhaustion = 25000, premium = false, type = 'Instant', icon = 127, mana = 80, level = 53, soul = 0, group = {[3] = 0}, vocations = {7}},
    ['Adaptive Punch'] = {id = 128, words = 'adaptive punch', icon_id = 128, description = 'advance technique that adapts based on the current 2 chi orbs combination you have.', exhaustion = 7000, premium = false, type = 'Instant', icon = 128, mana = 70, level = 38, soul = 0, group = {[3] = 2000}, vocations = {7}},
    ...
    ['Fist of Fire'] = {id = 132, words = 'fist of fire', icon_id = 132, description = 'after spending 2 fire chi orbs, send a flurry of blows wich deals fire damage.', exhaustion = 12000, premium = false, type = 'Instant', icon = 132, mana = 115, level = 80, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ['Volcanic Dash'] = {id = 133, words = 'volcanic dash', icon_id = 133, description = 'call the turtle spirit and dash to to your target dealing fire damage on impact.', exhaustion = 12000, premium = false, type = 'Instant', icon = 133, mana = 30, level = 45, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ['Stormfist'] = {id = 134, words = 'stormfist', icon_id = 134, description = 'for the next 3 seconds your physical damage sends a lighting shock to a nearby enemies.', exhaustion = 20000, premium = false, type = 'Instant', icon = 134, mana = 350, level = 1, soul = 0, group = {[1] = 0}, vocations = {7}, needLearn = true},
    ['Mountain Stance'] = {id = 135, words = 'mountain stance', icon_id = 135, description = 'for the next 10 seconds reduce damage taken by 30% and increases your max health by 25%', exhaustion = 50000, premium = false, type = 'Instant', icon = 135, mana = 80, level = 1, soul = 0, group = {[3] = 1900}, vocations = {7}, needLearn = true},
    ...
    ['Mystic Fist'] = {id = 137, words = 'mystic fist', icon_id = 137, description = 'spend any orb combination to cast a powerfull strike.', exhaustion = 20000, premium = false, type = 'Instant', icon = 137, mana = 220, level = 70, soul = 0, group = {[1] = 1900}, vocations = {7}},
    ['Crane Stance'] = {id = 138, words = 'crane stance', icon_id = 138, description = 'adopt the crane stance to increase your and all party members attack speed by 5% for 20 minutes.', exhaustion = 2000, premium = false, type = 'Instant', icon = 138, mana = 200, level = 60, soul = 0, group = {[3] = 1900}, vocations = {7}},
    ['Fist of Ice'] = {id = 139, words = 'fist of ice', icon_id = 139, description = 'after spending 2 ice chi orbs, send a flurry of blows wich deals ice damage and slows all enemies while being casted.', exhaustion = 12000, premium = false, type = 'Instant', icon = 139, mana = 115, level = 80, soul = 0, group = {[1] = 3000}, vocations = {7}},
    ['Fist of Life'] = {id = 140, words = 'fist of life', icon_id = 140, description = 'after spending 2 life chi orbs, send a flurry of blows wich heals all reached allies while being casted.', exhaustion = 12000, premium = false, type = 'Instant', icon = 140, mana = 250, level = 80, soul = 0, group = {[2] = 3000}, vocations = {7}},
    ...
    ['Life Bloom'] = {id = 152, words = 'life bloom', icon_id = 152, description = 'apply a powerfull bloom wich heals overtime you and all party members for 6 seconds. this spell will consume 25% of your max mana.', exhaustion = 8000, premium = false, type = 'Instant', icon = 152, mana = 0, level = 1, soul = 0, group = {[2] = 1900}, vocations = {8}, needLearn = true},
    ['Rejuvenation'] = {id = 153, words = 'rejuvenation', icon_id = 153, description = 'apply a rejuvenation effect to yourself wich heals overtime for 10 seconds.', exhaustion = 11000, premium = false, type = 'Instant', icon = 153, mana = 105, level = 53, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ...
    ['Travel Form'] = {id = 155, words = 'travel form', icon_id = 155, description = 'turn into your travel form, wich allows you to move faster but unable to cast spells.', exhaustion = 2000, premium = false, type = 'Instant', icon = 155, mana = 60, level = 60, soul = 0, group = {[3] = 2000}, vocations = {8}},
    ['Carnivorous Vile'] = {id = 156, words = 'carnivorous vile', icon_id = 156, description = 'cast a carnivorous vile wich devours its target dealing earth damage, if your target was infected by poison/earth/nature it does extra damage.', exhaustion = 5000, premium = false, type = 'Instant', icon = 156, mana = 85, level = 38, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['living ground'] = {id = 157, words = 'living ground', icon_id = 157, description = 'place a restoring field on the ground wich heals all allies while they stand on it.', exhaustion = 35000, premium = false, type = 'Instant', icon = 157, mana = 200, level = 1, soul = 0, group = {[2] = 1900}, vocations = {8}, needLearn = true},
    ['Piercing Wave'] = {id = 159, words = 'piercing wave', icon_id = 159, description = 'send a piercing wave that deals physical damage.', exhaustion = 8000, premium = false, type = 'Instant', icon = 159, mana = 155, level = 45, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ...
    ['Wrath of Nature'] = {id = 162, words = 'wrath of nature', icon_id = 162, description = 'cast a thunderstorm at your target position wich deals earth damage.', exhaustion = 26000, premium = false, type = 'Instant', icon = 162, mana = 380, level = 80, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ['Focus Healing'] = {id = 165, words = 'focus healing', icon_id = 165, description = 'strong heal, that heals your friendly target', exhaustion = 1000, parameter = true, premium = false, type = 'Instant', icon = 165, mana = 140, level = 60, soul = 0, group = {[2] = 1900}, vocations = {8}},
    ['Ice Shatter'] = {id = 166, words = 'ice shatter', icon_id = 166, description = 'create a ice block wich deals ice damage and it shatters itself to deal ice damage to all enemies in its radius.', exhaustion = 5000, premium = false, type = 'Instant', icon = 166, mana = 120, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true},
    ['Frost Armor'] = {id = 168, words = 'frost armor', icon_id = 168, description = 'cast a frost armor wich reduces damage taken by 20% and deals ice damage back to the attacker for 9 seconds.', exhaustion = 5000, premium = false, type = 'Instant', icon = 168, mana = 80, level = 1, soul = 0, group = {[1] = 1900}, vocations = {8}, needLearn = true},
    ['Ice Strike'] = {id = 169, words = 'ice strike', icon_id = 169, description = 'send an ice strike that chills the target and triggers a short delayed shard burst around it.', exhaustion = 3000, premium = false, type = 'Instant', icon = 169, mana = 35, level = 8, soul = 0, group = {[1] = 1900}, vocations = {8}},
    ...
    ['Static Charge'] = {id = 171, words = 'static charge', icon_id = 171, description = 'apply a static charge to yourself wich deals energy damage over time.', exhaustion = 2200, premium = false, type = 'Instant', icon = 171, mana = 30, level = 38, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Light Dash'] = {id = 172, words = 'light dash', icon_id = 172, description = 'dash to the target position and deal energy damage on impact.', exhaustion = 6000, premium = false, type = 'Instant', icon = 172, mana = 20, level = 53, soul = 0, group = {[1] = 0}, vocations = {9}},
    ['Veil of Swords'] = {id = 174, words = 'veil of swords', icon_id = 174, description = 'slash at lightning speed multiple times around yourself dealing physical damage.', exhaustion = 15000, premium = false, type = 'Instant', icon = 174, mana = 65, level = 45, soul = 0, group = {[3] = 1900}, vocations = {9}},
    ['Magnetic Shield'] = {id = 175, words = 'magnetic shield', icon_id = 175, description = 'gain damage immunity for 5 seconds to all damage types but reduce your damage done by 80%', exhaustion = 45000, premium = false, type = 'Instant', icon = 175, mana = 115, level = 1, soul = 0, group = {[3] = 0}, vocations = {9}, needLearn = true},
    ['Lightning Spear'] = {id = 176, words = 'lightning spear', icon_id = 176, description = 'send a lightning spear to the target that deals energy damage to all nearby enemies and also applies a static charge on impact.', exhaustion = 12000, premium = false, type = 'Instant', icon = 176, mana = 55, level = 38, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ['Overcharge'] = {id = 177, words = 'overcharge', icon_id = 177, description = 'gain a temporary 40% boost to your offensive skills for 8 seconds.', exhaustion = 30000, premium = false, type = 'Instant', icon = 177, mana = 115, level = 70, soul = 0, group = {[3] = 0}, vocations = {9}},
    ['Elusive Blade'] = {id = 178, words = 'elusive blade', icon_id = 178, description = 'slash your target with a strong strike dealing physical damage.', exhaustion = 9000, premium = false, type = 'Instant', icon = 178, mana = 65, level = 1, soul = 0, group = {[1] = 1900}, vocations = {9}, needLearn = true},
    ['Magnetic Orb'] = {id = 179, words = 'magnetic orb', icon_id = 179, description = 'create a magnetic orb at your target position that deals energy damage to all nearby enemies on its path.', exhaustion = 26000, premium = false, type = 'Instant', icon = 179, mana = 190, level = 80, soul = 0, group = {[1] = 1900}, vocations = {9}},
    ...
    ['Explosive Barrel'] =          {id = 182, icon_id = 182,words = 'explosive barrel', exhaustion = 15000, premium = false, type = 'Instant', icon = 182, mana = 150, level = 1, soul = 0, group = {[3] = 1900}, parameter = false, vocations = {10}, description = 'throws an explosive barrel that explodes after a short time duration, dealing area damage.', needLearn = true},
    ['Explosive Shot'] =            {id = 183, icon_id = 183, words = 'explosive shot', exhaustion = 7000, premium = false, type = 'Instant', icon = 183, mana = 70, level = 1, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoot 4 rounds of explosive shots dealing aoe damage to the target location, if the target is affected by beer barrel this spell will be powered and deal target max health damage. [Weapon Damage, DISTANCE]',needLearn = true},
    ['Wind Barrel'] =               {id = 184, icon_id = 184, words = 'wind barrel', exhaustion = 22000, premium = false, type = 'Instant', icon = 184, mana = 25, level = 53, soul = 0, group = {[3] = 1900}, parameter = false, vocations = {10}, description = 'creates a wind barrel that explodes after a short time duration increasing your movement speed drastically.'},
    ['Condemn Shot'] =              {id = 185, icon_id = 185, words = 'condemn shot', exhaustion = 25000, premium = false, type = 'Instant', icon = 185, mana = 60, level = 60, soul = 0, group = {[3] = 1900}, parameter = false, vocations = {10}, description = 'repels your target away from the caster. [Weapon Damage, DISTANCE]'},
    ['Healing Barrel'] =            {id = 187, icon_id = 187, words = 'healing barrel', exhaustion = 20000, premium = false, type = 'Instant', icon = 187, mana = 200, level = 60, soul = 0, group = {[2] = 1900}, parameter = false, vocations = {10}, description = 'creates a healing barrel that explodes after a short time duration healing all players in the area.'},
    ['Arrow rain'] =                {id = 188, icon_id = 188, words = 'arrow rain', exhaustion = 15000, premium = false, type = 'Instant', icon = 188, mana = 200, level = 75, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'cast a arrow rain into the target dealing physical damage to all enemies in the area.[Weapon Damage, DISTANCE]'},
    ['Frost Barrel'] =              {id = 189, icon_id = 189,words = 'frost barrel', exhaustion = 15000, premium = false, type = 'Instant', icon = 189, mana = 150, level = 1, soul = 0, group = {[3] = 1900}, parameter = false, vocations = {10}, description = 'creates a frost barrel that explodes after a short time duration freezing all enemies in the area.',needLearn = true},
    ['Phantom Shot'] =              {id = 190, icon_id = 190, words = 'phantom shot', exhaustion = 6000, premium = false, type = 'Instant', icon = 190, mana = 35, level = 1, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots a phantom shot at the target, dealing high damage. [Weapon Damage, DISTANCE]',needLearn = true},
    ['Arrow Barrage'] =             {id = 191, icon_id = 191, words = 'arrow barrage', exhaustion = 16000, premium = false, type = 'Instant', icon = 191, mana = 115, level = 45, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoot multiple dark shots into all nearby enemies dealing physical damage. [Weapon Damage, DISTANCE]'},
    ['Rapid Fire'] =                {id = 192, icon_id = 192, words = 'rapid fire', exhaustion = 6000, premium = false, type = 'Instant', icon = 192, mana = 55, level = 38, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots a rapid succession of arrows at the target. [Weapon Damage, DISTANCE]'},
    ['Ice Arrow'] =                 {id = 193, icon_id = 193, words = 'ice arrow', exhaustion = 3000, premium = false, type = 'Instant', icon = 193, mana = 50, level = 8, soul = 0, group = {[1] = 1900}, parameter = false, vocations = {10}, description = 'shoots an ice arrow at the target, dealing ice damage and slowing the target. [Weapon Damage, DISTANCE]',needLearn = true},
