...
SpellInfo = {
  ['Custom'] = {
   ...
   --Stellar
    ...
    ['Blood Curse'] = {id = 313, words = 'blood curse', icon = 66, description = 'Strike your target with strong death damage, heal yourself, and amplify all existing bleeds on the target by 50%. Also applies a curse bleed (5 ticks, 30% heal). Generates 20 Blood Essence. Costs 3% max HP.', exhaustion = 12000, premium = false, needLearn = true, type = 'Instant', mana = 0, level = 1, soul = 0, group = {[1] = 1900}, vocations = {14}},
