...
function onGameStart() 
  g_logger.warning("store@onGameStart")
end

function onGameEnd() 
  g_logger.warning("store@onGameEnd")
end

-- setup window modules
function init()
  g_logger.warning("store@init")
...
function terminate()
  g_logger.warning("store@terminate")
...
g_logger.warning("store@onExtendedOpcode " .. tostring(code))
...
-- the server sends an opcode to fetch?

function fetch() 
  g_logger.warning("store@fetch")
  local protocolGame = g_game.getProtocolGame()
  if protocolGame then
    g_logger.warning("store@fetching")
...
function destroy()
  g_logger.warning("store@destroy")
