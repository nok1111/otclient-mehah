PassiveSkills.nodeInfo = {
	...
	["2:7"] = {
		...
		description = "Judgement now heals 2% of your max health per level and grants +3% holy damage per level for 5 seconds.",
		effect = {
	...
	["10:26"] = {
		...
		description = "Phantom Shot, Falcon Shot and Rapid Fire deal +5% damage per level for each debuff on the target (slow, burn, bleed, freeze, poison, cursed, electrified). Also increases the duration of your Falcon Shot bleed and Deadeye poison by 0.5 seconds per level.",
		effect = {
	...
	["14:0"] = {
		...
		description = "Blood is power. Increases your Magic Level by 1 point for each 200 max health points.",
		effect = {
	...
	["14:8"] = {
		...
		description = "Blood Eruption damage +50%. Survivors of Blood Eruption get a new bleed applied (4 ticks). Each tick heals the caster for 25% of the damage dealt.",
		effect = {
