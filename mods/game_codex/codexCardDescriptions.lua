...
Codex.cardDescriptions = {
	...
	[6] = {
		...
		descriptions = {
			...
			[4] = "Pain fuels your arcane reserves - 16% of damage taken is converted into mana",
			[5] = "Pain fuels your arcane reserves - 15% of damage taken is converted into mana",
